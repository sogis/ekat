SELECT min(k.ogc_fid) AS ogc_fid, min(k.xkoord) AS xkoord, 
   ...
   FROM ( SELECT a.ogc_fid, a.xkoord, a.ykoord, a.wkb_geometry, a.gem_bfs, 
            b.vsit, 
                CASE
                    WHEN b.neigung = 0 AND b.vsit::text = 'Land/AB/100'::text THEN b.dtv2015_snf::double precision * ((( SELECT a.efak
                    ...
                    WHEN b.neigung = 2 AND b.vsit::text = 'Land/AB/100'::text THEN b.dtv2015_snf::double precision * ((( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                    ...
                    WHEN b.neigung = 4 AND b.vsit::text = 'Land/AB/100'::text THEN b.dtv2015_snf::double precision * ((( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                    ...
                    WHEN b.neigung = 6 AND b.vsit::text = 'Land/AB/100'::text THEN b.dtv2015_snf::double precision * ((( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                    ...
                    WHEN b.neigung = 0 AND b.vsit::text = 'Land/AB/120'::text THEN b.dtv2015_snf::double precision * ((( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                    ...
                    WHEN b.neigung = 2 AND b.vsit::text = 'Land/AB/120'::text THEN b.dtv2015_snf::double precision * ((( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                    ...
                    WHEN b.neigung = 4 AND b.vsit::text = 'Land/AB/120'::text THEN b.dtv2015_snf::double precision * ((( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                    ...
                    WHEN b.neigung = 6 AND b.vsit::text = 'Land/AB/120'::text THEN b.dtv2015_snf::double precision * ((( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                    ...
                    WHEN b.neigung = 0 AND b.vsit::text = 'Land/AB/80'::text THEN b.dtv2015_snf::double precision * ((( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                    ...
                    WHEN b.neigung = 2 AND b.vsit::text = 'Land/AB/80'::text THEN b.dtv2015_snf::double precision * ((( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                    ...
                    WHEN b.neigung = 4 AND b.vsit::text = 'Land/AB/80'::text THEN b.dtv2015_snf::double precision * ((( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                    ...
                    WHEN b.neigung = 6 AND b.vsit::text = 'Land/AB/80'::text THEN b.dtv2015_snf::double precision * ((( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                    ...
                    WHEN b.neigung = 0 AND b.vsit::text = 'Land/Erschliessung/30'::text THEN b.dtv2015_snf::double precision * ((( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 5 AND a.vk_sit = 'Land/Erschliessung/30/fluessig'::text AND a.neigung = 0)) * b.ant_los1 + (( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 5 AND a.vk_sit = 'Land/Erschliessung/30/dicht'::text AND a.neigung = 0)) * b.ant_los2 + (( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 5 AND a.vk_sit = 'Land/Erschliessung/30/gesaettigt'::text AND a.neigung = 0)) * b.ant_los3 + (( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 5 AND a.vk_sit = 'Land/Erschliessung/30/stop+go'::text AND a.neigung = 0)) * b.ant_los4) * 365::double precision / 1000::double precision
                    WHEN b.neigung = 2 AND b.vsit::text = 'Land/Erschliessung/30'::text THEN b.dtv2015_snf::double precision * ((( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 5 AND a.vk_sit = 'Land/Erschliessung/30/fluessig'::text AND a.neigung = 2)) * b.ant_los1 + (( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 5 AND a.vk_sit = 'Land/Erschliessung/30/dicht'::text AND a.neigung = 2)) * b.ant_los2 + (( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 5 AND a.vk_sit = 'Land/Erschliessung/30/gesaettigt'::text AND a.neigung = 2)) * b.ant_los3 + (( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 5 AND a.vk_sit = 'Land/Erschliessung/30/stop+go'::text AND a.neigung = 2)) * b.ant_los4) * 365::double precision / 1000::double precision
                    WHEN b.neigung = 4 AND b.vsit::text = 'Land/Erschliessung/30'::text THEN b.dtv2015_snf::double precision * ((( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 5 AND a.vk_sit = 'Land/Erschliessung/30/fluessig'::text AND a.neigung = 4)) * b.ant_los1 + (( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 5 AND a.vk_sit = 'Land/Erschliessung/30/dicht'::text AND a.neigung = 4)) * b.ant_los2 + (( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 5 AND a.vk_sit = 'Land/Erschliessung/30/gesaettigt'::text AND a.neigung = 4)) * b.ant_los3 + (( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 5 AND a.vk_sit = 'Land/Erschliessung/30/stop+go'::text AND a.neigung = 4)) * b.ant_los4) * 365::double precision / 1000::double precision
                    WHEN b.neigung = 6 AND b.vsit::text = 'Land/Erschliessung/30'::text THEN b.dtv2015_snf::double precision * ((( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 5 AND a.vk_sit = 'Land/Erschliessung/30/fluessig'::text AND a.neigung = 6)) * b.ant_los1 + (( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 5 AND a.vk_sit = 'Land/Erschliessung/30/dicht'::text AND a.neigung = 6)) * b.ant_los2 + (( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 5 AND a.vk_sit = 'Land/Erschliessung/30/gesaettigt'::text AND a.neigung = 6)) * b.ant_los3 + (( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 5 AND a.vk_sit = 'Land/Erschliessung/30/stop+go'::text AND a.neigung = 6)) * b.ant_los4) * 365::double precision / 1000::double precision
                    WHEN b.neigung = 0 AND b.vsit::text = 'Land/Erschliessung/40'::text THEN b.dtv2015_snf::double precision * ((( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 5 AND a.vk_sit = 'Land/Erschliessung/40/fluessig'::text AND a.neigung = 0)) * b.ant_los1 + (( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 5 AND a.vk_sit = 'Land/Erschliessung/40/dicht'::text AND a.neigung = 0)) * b.ant_los2 + (( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 5 AND a.vk_sit = 'Land/Erschliessung/40/gesaettigt'::text AND a.neigung = 0)) * b.ant_los3 + (( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 5 AND a.vk_sit = 'Land/Erschliessung/40/stop+go'::text AND a.neigung = 0)) * b.ant_los4) * 365::double precision / 1000::double precision
                    WHEN b.neigung = 2 AND b.vsit::text = 'Land/Erschliessung/40'::text THEN b.dtv2015_snf::double precision * ((( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 5 AND a.vk_sit = 'Land/Erschliessung/40/fluessig'::text AND a.neigung = 2)) * b.ant_los1 + (( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 5 AND a.vk_sit = 'Land/Erschliessung/40/dicht'::text AND a.neigung = 2)) * b.ant_los2 + (( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 5 AND a.vk_sit = 'Land/Erschliessung/40/gesaettigt'::text AND a.neigung = 2)) * b.ant_los3 + (( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 5 AND a.vk_sit = 'Land/Erschliessung/40/stop+go'::text AND a.neigung = 2)) * b.ant_los4) * 365::double precision / 1000::double precision
                    WHEN b.neigung = 4 AND b.vsit::text = 'Land/Erschliessung/40'::text THEN b.dtv2015_snf::double precision * ((( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 5 AND a.vk_sit = 'Land/Erschliessung/40/fluessig'::text AND a.neigung = 4)) * b.ant_los1 + (( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 5 AND a.vk_sit = 'Land/Erschliessung/40/dicht'::text AND a.neigung = 4)) * b.ant_los2 + (( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 5 AND a.vk_sit = 'Land/Erschliessung/40/gesaettigt'::text AND a.neigung = 4)) * b.ant_los3 + (( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 5 AND a.vk_sit = 'Land/Erschliessung/40/stop+go'::text AND a.neigung = 4)) * b.ant_los4) * 365::double precision / 1000::double precision
                    WHEN b.neigung = 6 AND b.vsit::text = 'Land/Erschliessung/40'::text THEN b.dtv2015_snf::double precision * ((( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 5 AND a.vk_sit = 'Land/Erschliessung/40/fluessig'::text AND a.neigung = 6)) * b.ant_los1 + (( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 5 AND a.vk_sit = 'Land/Erschliessung/40/dicht'::text AND a.neigung = 6)) * b.ant_los2 + (( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 5 AND a.vk_sit = 'Land/Erschliessung/40/gesaettigt'::text AND a.neigung = 6)) * b.ant_los3 + (( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 5 AND a.vk_sit = 'Land/Erschliessung/40/stop+go'::text AND a.neigung = 6)) * b.ant_los4) * 365::double precision / 1000::double precision
                    WHEN b.neigung = 0 AND b.vsit::text = 'Land/Erschliessung/50'::text THEN b.dtv2015_snf::double precision * ((( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                    ...
                    WHEN b.neigung = 2 AND b.vsit::text = 'Land/Erschliessung/50'::text THEN b.dtv2015_snf::double precision * ((( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                    ...
                    WHEN b.neigung = 4 AND b.vsit::text = 'Land/Erschliessung/50'::text THEN b.dtv2015_snf::double precision * ((( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                    ...
                    WHEN b.neigung = 6 AND b.vsit::text = 'Land/Erschliessung/50'::text THEN b.dtv2015_snf::double precision * ((( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                    ...
                    WHEN b.neigung = 0 AND b.vsit::text = 'Land/HVS/30'::text THEN b.dtv2015_snf::double precision * ((( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 5 AND a.vk_sit = 'Land/HVS/30/fluessig'::text AND a.neigung = 0)) * b.ant_los1 + (( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 5 AND a.vk_sit = 'Land/HVS/30/dicht'::text AND a.neigung = 0)) * b.ant_los2 + (( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 5 AND a.vk_sit = 'Land/HVS/30/gesaettigt'::text AND a.neigung = 0)) * b.ant_los3 + (( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 5 AND a.vk_sit = 'Land/HVS/30/stop+go'::text AND a.neigung = 0)) * b.ant_los4) * 365::double precision / 1000::double precision
                    WHEN b.neigung = 2 AND b.vsit::text = 'Land/HVS/30'::text THEN b.dtv2015_snf::double precision * ((( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 5 AND a.vk_sit = 'Land/HVS/30/fluessig'::text AND a.neigung = 2)) * b.ant_los1 + (( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 5 AND a.vk_sit = 'Land/HVS/30/dicht'::text AND a.neigung = 2)) * b.ant_los2 + (( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 5 AND a.vk_sit = 'Land/HVS/30/gesaettigt'::text AND a.neigung = 2)) * b.ant_los3 + (( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 5 AND a.vk_sit = 'Land/HVS/30/stop+go'::text AND a.neigung = 2)) * b.ant_los4) * 365::double precision / 1000::double precision
                    WHEN b.neigung = 4 AND b.vsit::text = 'Land/HVS/30'::text THEN b.dtv2015_snf::double precision * ((( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 5 AND a.vk_sit = 'Land/HVS/30/fluessig'::text AND a.neigung = 4)) * b.ant_los1 + (( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 5 AND a.vk_sit = 'Land/HVS/30/dicht'::text AND a.neigung = 4)) * b.ant_los2 + (( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 5 AND a.vk_sit = 'Land/HVS/30/gesaettigt'::text AND a.neigung = 4)) * b.ant_los3 + (( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 5 AND a.vk_sit = 'Land/HVS/30/stop+go'::text AND a.neigung = 4)) * b.ant_los4) * 365::double precision / 1000::double precision
                    WHEN b.neigung = 6 AND b.vsit::text = 'Land/HVS/30'::text THEN b.dtv2015_snf::double precision * ((( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 5 AND a.vk_sit = 'Land/HVS/30/fluessig'::text AND a.neigung = 6)) * b.ant_los1 + (( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 5 AND a.vk_sit = 'Land/HVS/30/dicht'::text AND a.neigung = 6)) * b.ant_los2 + (( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 5 AND a.vk_sit = 'Land/HVS/30/gesaettigt'::text AND a.neigung = 6)) * b.ant_los3 + (( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 5 AND a.vk_sit = 'Land/HVS/30/stop+go'::text AND a.neigung = 6)) * b.ant_los4) * 365::double precision / 1000::double precision
                    WHEN b.neigung = 0 AND b.vsit::text = 'Land/HVS/40'::text THEN b.dtv2015_snf::double precision * ((( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 5 AND a.vk_sit = 'Land/HVS/40/fluessig'::text AND a.neigung = 0)) * b.ant_los1 + (( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 5 AND a.vk_sit = 'Land/HVS/40/dicht'::text AND a.neigung = 0)) * b.ant_los2 + (( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 5 AND a.vk_sit = 'Land/HVS/40/gesaettigt'::text AND a.neigung = 0)) * b.ant_los3 + (( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 5 AND a.vk_sit = 'Land/HVS/40/stop+go'::text AND a.neigung = 0)) * b.ant_los4) * 365::double precision / 1000::double precision
                    WHEN b.neigung = 2 AND b.vsit::text = 'Land/HVS/40'::text THEN b.dtv2015_snf::double precision * ((( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 5 AND a.vk_sit = 'Land/HVS/40/fluessig'::text AND a.neigung = 2)) * b.ant_los1 + (( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 5 AND a.vk_sit = 'Land/HVS/40/dicht'::text AND a.neigung = 2)) * b.ant_los2 + (( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 5 AND a.vk_sit = 'Land/HVS/40/gesaettigt'::text AND a.neigung = 2)) * b.ant_los3 + (( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 5 AND a.vk_sit = 'Land/HVS/40/stop+go'::text AND a.neigung = 2)) * b.ant_los4) * 365::double precision / 1000::double precision
                    WHEN b.neigung = 4 AND b.vsit::text = 'Land/HVS/40'::text THEN b.dtv2015_snf::double precision * ((( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 5 AND a.vk_sit = 'Land/HVS/40/fluessig'::text AND a.neigung = 4)) * b.ant_los1 + (( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 5 AND a.vk_sit = 'Land/HVS/40/dicht'::text AND a.neigung = 4)) * b.ant_los2 + (( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 5 AND a.vk_sit = 'Land/HVS/40/gesaettigt'::text AND a.neigung = 4)) * b.ant_los3 + (( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 5 AND a.vk_sit = 'Land/HVS/40/stop+go'::text AND a.neigung = 4)) * b.ant_los4) * 365::double precision / 1000::double precision
                    WHEN b.neigung = 6 AND b.vsit::text = 'Land/HVS/40'::text THEN b.dtv2015_snf::double precision * ((( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 5 AND a.vk_sit = 'Land/HVS/40/fluessig'::text AND a.neigung = 6)) * b.ant_los1 + (( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 5 AND a.vk_sit = 'Land/HVS/40/dicht'::text AND a.neigung = 6)) * b.ant_los2 + (( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 5 AND a.vk_sit = 'Land/HVS/40/gesaettigt'::text AND a.neigung = 6)) * b.ant_los3 + (( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 5 AND a.vk_sit = 'Land/HVS/40/stop+go'::text AND a.neigung = 6)) * b.ant_los4) * 365::double precision / 1000::double precision
                    WHEN b.neigung = 0 AND b.vsit::text = 'Land/HVS/50'::text THEN b.dtv2015_snf::double precision * ((( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 5 AND a.vk_sit = 'Land/HVS/50/fluessig'::text AND a.neigung = 0)) * b.ant_los1 + (( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 5 AND a.vk_sit = 'Land/HVS/50/dicht'::text AND a.neigung = 0)) * b.ant_los2 + (( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 5 AND a.vk_sit = 'Land/HVS/50/gesaettigt'::text AND a.neigung = 0)) * b.ant_los3 + (( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 5 AND a.vk_sit = 'Land/HVS/50/stop+go'::text AND a.neigung = 0)) * b.ant_los4) * 365::double precision / 1000::double precision
                    WHEN b.neigung = 2 AND b.vsit::text = 'Land/HVS/50'::text THEN b.dtv2015_snf::double precision * ((( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 5 AND a.vk_sit = 'Land/HVS/50/fluessig'::text AND a.neigung = 2)) * b.ant_los1 + (( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 5 AND a.vk_sit = 'Land/HVS/50/dicht'::text AND a.neigung = 2)) * b.ant_los2 + (( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 5 AND a.vk_sit = 'Land/HVS/50/gesaettigt'::text AND a.neigung = 2)) * b.ant_los3 + (( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 5 AND a.vk_sit = 'Land/HVS/50/stop+go'::text AND a.neigung = 2)) * b.ant_los4) * 365::double precision / 1000::double precision
                    WHEN b.neigung = 4 AND b.vsit::text = 'Land/HVS/50'::text THEN b.dtv2015_snf::double precision * ((( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 5 AND a.vk_sit = 'Land/HVS/50/fluessig'::text AND a.neigung = 4)) * b.ant_los1 + (( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 5 AND a.vk_sit = 'Land/HVS/50/dicht'::text AND a.neigung = 4)) * b.ant_los2 + (( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 5 AND a.vk_sit = 'Land/HVS/50/gesaettigt'::text AND a.neigung = 4)) * b.ant_los3 + (( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 5 AND a.vk_sit = 'Land/HVS/50/stop+go'::text AND a.neigung = 4)) * b.ant_los4) * 365::double precision / 1000::double precision
                    WHEN b.neigung = 6 AND b.vsit::text = 'Land/HVS/50'::text THEN b.dtv2015_snf::double precision * ((( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 5 AND a.vk_sit = 'Land/HVS/50/fluessig'::text AND a.neigung = 6)) * b.ant_los1 + (( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 5 AND a.vk_sit = 'Land/HVS/50/dicht'::text AND a.neigung = 6)) * b.ant_los2 + (( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 5 AND a.vk_sit = 'Land/HVS/50/gesaettigt'::text AND a.neigung = 6)) * b.ant_los3 + (( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 5 AND a.vk_sit = 'Land/HVS/50/stop+go'::text AND a.neigung = 6)) * b.ant_los4) * 365::double precision / 1000::double precision
                    WHEN b.neigung = 0 AND b.vsit::text = 'Land/HVS/60'::text THEN b.dtv2015_snf::double precision * ((( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 5 AND a.vk_sit = 'Land/HVS/60/fluessig'::text AND a.neigung = 0)) * b.ant_los1 + (( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 5 AND a.vk_sit = 'Land/HVS/60/dicht'::text AND a.neigung = 0)) * b.ant_los2 + (( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 5 AND a.vk_sit = 'Land/HVS/60/gesaettigt'::text AND a.neigung = 0)) * b.ant_los3 + (( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 5 AND a.vk_sit = 'Land/HVS/60/stop+go'::text AND a.neigung = 0)) * b.ant_los4) * 365::double precision / 1000::double precision
                    WHEN b.neigung = 2 AND b.vsit::text = 'Land/HVS/60'::text THEN b.dtv2015_snf::double precision * ((( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 5 AND a.vk_sit = 'Land/HVS/60/fluessig'::text AND a.neigung = 2)) * b.ant_los1 + (( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 5 AND a.vk_sit = 'Land/HVS/60/dicht'::text AND a.neigung = 2)) * b.ant_los2 + (( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 5 AND a.vk_sit = 'Land/HVS/60/gesaettigt'::text AND a.neigung = 2)) * b.ant_los3 + (( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 5 AND a.vk_sit = 'Land/HVS/60/stop+go'::text AND a.neigung = 2)) * b.ant_los4) * 365::double precision / 1000::double precision
                    WHEN b.neigung = 4 AND b.vsit::text = 'Land/HVS/60'::text THEN b.dtv2015_snf::double precision * ((( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 5 AND a.vk_sit = 'Land/HVS/60/fluessig'::text AND a.neigung = 4)) * b.ant_los1 + (( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 5 AND a.vk_sit = 'Land/HVS/60/dicht'::text AND a.neigung = 4)) * b.ant_los2 + (( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 5 AND a.vk_sit = 'Land/HVS/60/gesaettigt'::text AND a.neigung = 4)) * b.ant_los3 + (( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 5 AND a.vk_sit = 'Land/HVS/60/stop+go'::text AND a.neigung = 4)) * b.ant_los4) * 365::double precision / 1000::double precision
                    WHEN b.neigung = 6 AND b.vsit::text = 'Land/HVS/60'::text THEN b.dtv2015_snf::double precision * ((( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 5 AND a.vk_sit = 'Land/HVS/60/fluessig'::text AND a.neigung = 6)) * b.ant_los1 + (( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 5 AND a.vk_sit = 'Land/HVS/60/dicht'::text AND a.neigung = 6)) * b.ant_los2 + (( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 5 AND a.vk_sit = 'Land/HVS/60/gesaettigt'::text AND a.neigung = 6)) * b.ant_los3 + (( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 5 AND a.vk_sit = 'Land/HVS/60/stop+go'::text AND a.neigung = 6)) * b.ant_los4) * 365::double precision / 1000::double precision
                    WHEN b.neigung = 0 AND b.vsit::text = 'Land/HVS/70'::text THEN b.dtv2015_snf::double precision * ((( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                    ...
                    WHEN b.neigung = 2 AND b.vsit::text = 'Land/HVS/70'::text THEN b.dtv2015_snf::double precision * ((( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                    ...
                    WHEN b.neigung = 4 AND b.vsit::text = 'Land/HVS/70'::text THEN b.dtv2015_snf::double precision * ((( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                    ...
                    WHEN b.neigung = 6 AND b.vsit::text = 'Land/HVS/70'::text THEN b.dtv2015_snf::double precision * ((( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                    ...
                    WHEN b.neigung = 0 AND b.vsit::text = 'Land/HVS/80'::text THEN b.dtv2015_snf::double precision * ((( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                    ...
                    WHEN b.neigung = 2 AND b.vsit::text = 'Land/HVS/80'::text THEN b.dtv2015_snf::double precision * ((( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                    ...
                    WHEN b.neigung = 4 AND b.vsit::text = 'Land/HVS/80'::text THEN b.dtv2015_snf::double precision * ((( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                    ...
                    WHEN b.neigung = 6 AND b.vsit::text = 'Land/HVS/80'::text THEN b.dtv2015_snf::double precision * ((( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                    ...
                    WHEN b.neigung = 0 AND b.vsit::text = 'Land/HVS-kurv./70'::text THEN b.dtv2015_snf::double precision * ((( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                    ...
                    WHEN b.neigung = 2 AND b.vsit::text = 'Land/HVS-kurv./70'::text THEN b.dtv2015_snf::double precision * ((( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                    ...
                    WHEN b.neigung = 4 AND b.vsit::text = 'Land/HVS-kurv./70'::text THEN b.dtv2015_snf::double precision * ((( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                    ...
                    WHEN b.neigung = 6 AND b.vsit::text = 'Land/HVS-kurv./70'::text THEN b.dtv2015_snf::double precision * ((( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                    ...
                    WHEN b.neigung = 0 AND b.vsit::text = 'Land/Sammel/50'::text THEN b.dtv2015_snf::double precision * ((( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 5 AND a.vk_sit = 'Land/Sammel/50/fluessig'::text AND a.neigung = 0)) * b.ant_los1 + (( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 5 AND a.vk_sit = 'Land/Sammel/50/dicht'::text AND a.neigung = 0)) * b.ant_los2 + (( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 5 AND a.vk_sit = 'Land/Sammel/50/gesaettigt'::text AND a.neigung = 0)) * b.ant_los3 + (( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 5 AND a.vk_sit = 'Land/Sammel/50/stop+go'::text AND a.neigung = 0)) * b.ant_los4) * 365::double precision / 1000::double precision
                    WHEN b.neigung = 2 AND b.vsit::text = 'Land/Sammel/50'::text THEN b.dtv2015_snf::double precision * ((( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 5 AND a.vk_sit = 'Land/Sammel/50/fluessig'::text AND a.neigung = 2)) * b.ant_los1 + (( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 5 AND a.vk_sit = 'Land/Sammel/50/dicht'::text AND a.neigung = 2)) * b.ant_los2 + (( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 5 AND a.vk_sit = 'Land/Sammel/50/gesaettigt'::text AND a.neigung = 2)) * b.ant_los3 + (( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 5 AND a.vk_sit = 'Land/Sammel/50/stop+go'::text AND a.neigung = 2)) * b.ant_los4) * 365::double precision / 1000::double precision
                    WHEN b.neigung = 4 AND b.vsit::text = 'Land/Sammel/50'::text THEN b.dtv2015_snf::double precision * ((( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 5 AND a.vk_sit = 'Land/Sammel/50/fluessig'::text AND a.neigung = 4)) * b.ant_los1 + (( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 5 AND a.vk_sit = 'Land/Sammel/50/dicht'::text AND a.neigung = 4)) * b.ant_los2 + (( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 5 AND a.vk_sit = 'Land/Sammel/50/gesaettigt'::text AND a.neigung = 4)) * b.ant_los3 + (( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 5 AND a.vk_sit = 'Land/Sammel/50/stop+go'::text AND a.neigung = 4)) * b.ant_los4) * 365::double precision / 1000::double precision
                    WHEN b.neigung = 6 AND b.vsit::text = 'Land/Sammel/50'::text THEN b.dtv2015_snf::double precision * ((( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 5 AND a.vk_sit = 'Land/Sammel/50/fluessig'::text AND a.neigung = 6)) * b.ant_los1 + (( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 5 AND a.vk_sit = 'Land/Sammel/50/dicht'::text AND a.neigung = 6)) * b.ant_los2 + (( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 5 AND a.vk_sit = 'Land/Sammel/50/gesaettigt'::text AND a.neigung = 6)) * b.ant_los3 + (( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 5 AND a.vk_sit = 'Land/Sammel/50/stop+go'::text AND a.neigung = 6)) * b.ant_los4) * 365::double precision / 1000::double precision
                    WHEN b.neigung = 0 AND b.vsit::text = 'Land/Sammel/60'::text THEN b.dtv2015_snf::double precision * ((( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                    ...
                    WHEN b.neigung = 2 AND b.vsit::text = 'Land/Sammel/60'::text THEN b.dtv2015_snf::double precision * ((( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                    ...
                    WHEN b.neigung = 4 AND b.vsit::text = 'Land/Sammel/60'::text THEN b.dtv2015_snf::double precision * ((( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                    ...
                    WHEN b.neigung = 6 AND b.vsit::text = 'Land/Sammel/60'::text THEN b.dtv2015_snf::double precision * ((( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                    ...
                    WHEN b.neigung = 0 AND b.vsit::text = 'Land/Sammel/70'::text THEN b.dtv2015_snf::double precision * ((( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                    ...
                    WHEN b.neigung = 2 AND b.vsit::text = 'Land/Sammel/70'::text THEN b.dtv2015_snf::double precision * ((( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                    ...
                    WHEN b.neigung = 4 AND b.vsit::text = 'Land/Sammel/70'::text THEN b.dtv2015_snf::double precision * ((( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                    ...
                    WHEN b.neigung = 6 AND b.vsit::text = 'Land/Sammel/70'::text THEN b.dtv2015_snf::double precision * ((( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                    ...
                    WHEN b.neigung = 0 AND b.vsit::text = 'Land/Sammel/80'::text THEN b.dtv2015_snf::double precision * ((( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                    ...
                    WHEN b.neigung = 2 AND b.vsit::text = 'Land/Sammel/80'::text THEN b.dtv2015_snf::double precision * ((( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                    ...
                    WHEN b.neigung = 4 AND b.vsit::text = 'Land/Sammel/80'::text THEN b.dtv2015_snf::double precision * ((( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                    ...
                    WHEN b.neigung = 6 AND b.vsit::text = 'Land/Sammel/80'::text THEN b.dtv2015_snf::double precision * ((( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                    ...
                    WHEN b.neigung = 0 AND b.vsit::text = 'Land/Sammel-kurv./60'::text THEN b.dtv2015_snf::double precision * ((( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                    ...
                    WHEN b.neigung = 2 AND b.vsit::text = 'Land/Sammel-kurv./60'::text THEN b.dtv2015_snf::double precision * ((( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                    ...
                    WHEN b.neigung = 4 AND b.vsit::text = 'Land/Sammel-kurv./60'::text THEN b.dtv2015_snf::double precision * ((( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                    ...
                    WHEN b.neigung = 6 AND b.vsit::text = 'Land/Sammel-kurv./60'::text THEN b.dtv2015_snf::double precision * ((( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                    ...
                    WHEN b.neigung = 0 AND b.vsit::text = 'Land/Sammel-kurv./70'::text THEN b.dtv2015_snf::double precision * ((( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                    ...
                    WHEN b.neigung = 2 AND b.vsit::text = 'Land/Sammel-kurv./70'::text THEN b.dtv2015_snf::double precision * ((( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                    ...
                    WHEN b.neigung = 4 AND b.vsit::text = 'Land/Sammel-kurv./70'::text THEN b.dtv2015_snf::double precision * ((( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                    ...
                    WHEN b.neigung = 6 AND b.vsit::text = 'Land/Sammel-kurv./70'::text THEN b.dtv2015_snf::double precision * ((( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                    ...
                    WHEN b.neigung = 0 AND b.vsit::text = 'Land/Sammel-kurv./80'::text THEN b.dtv2015_snf::double precision * ((( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                    ...
                    WHEN b.neigung = 2 AND b.vsit::text = 'Land/Sammel-kurv./80'::text THEN b.dtv2015_snf::double precision * ((( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                    ...
                    WHEN b.neigung = 4 AND b.vsit::text = 'Land/Sammel-kurv./80'::text THEN b.dtv2015_snf::double precision * ((( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                    ...
                    WHEN b.neigung = 6 AND b.vsit::text = 'Land/Sammel-kurv./80'::text THEN b.dtv2015_snf::double precision * ((( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                ...
                CASE
                    ...
                    WHEN b.neigung = 0 AND b.vsit::text = 'Land/Erschliessung/30'::text THEN b.dtv2015_snf::double precision * ((( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 25 AND a.vk_sit = 'Land/Erschliessung/30/fluessig'::text AND a.neigung = 0)) * b.ant_los1 + (( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 25 AND a.vk_sit = 'Land/Erschliessung/30/dicht'::text AND a.neigung = 0)) * b.ant_los2 + (( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 25 AND a.vk_sit = 'Land/Erschliessung/30/gesaettigt'::text AND a.neigung = 0)) * b.ant_los3 + (( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 25 AND a.vk_sit = 'Land/Erschliessung/30/stop+go'::text AND a.neigung = 0)) * b.ant_los4) * 365::double precision / 1000::double precision
                    WHEN b.neigung = 2 AND b.vsit::text = 'Land/Erschliessung/30'::text THEN b.dtv2015_snf::double precision * ((( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 25 AND a.vk_sit = 'Land/Erschliessung/30/fluessig'::text AND a.neigung = 2)) * b.ant_los1 + (( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 25 AND a.vk_sit = 'Land/Erschliessung/30/dicht'::text AND a.neigung = 2)) * b.ant_los2 + (( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 25 AND a.vk_sit = 'Land/Erschliessung/30/gesaettigt'::text AND a.neigung = 2)) * b.ant_los3 + (( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 25 AND a.vk_sit = 'Land/Erschliessung/30/stop+go'::text AND a.neigung = 2)) * b.ant_los4) * 365::double precision / 1000::double precision
                    WHEN b.neigung = 4 AND b.vsit::text = 'Land/Erschliessung/30'::text THEN b.dtv2015_snf::double precision * ((( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 25 AND a.vk_sit = 'Land/Erschliessung/30/fluessig'::text AND a.neigung = 4)) * b.ant_los1 + (( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 25 AND a.vk_sit = 'Land/Erschliessung/30/dicht'::text AND a.neigung = 4)) * b.ant_los2 + (( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 25 AND a.vk_sit = 'Land/Erschliessung/30/gesaettigt'::text AND a.neigung = 4)) * b.ant_los3 + (( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 25 AND a.vk_sit = 'Land/Erschliessung/30/stop+go'::text AND a.neigung = 4)) * b.ant_los4) * 365::double precision / 1000::double precision
                    WHEN b.neigung = 6 AND b.vsit::text = 'Land/Erschliessung/30'::text THEN b.dtv2015_snf::double precision * ((( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 25 AND a.vk_sit = 'Land/Erschliessung/30/fluessig'::text AND a.neigung = 6)) * b.ant_los1 + (( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 25 AND a.vk_sit = 'Land/Erschliessung/30/dicht'::text AND a.neigung = 6)) * b.ant_los2 + (( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 25 AND a.vk_sit = 'Land/Erschliessung/30/gesaettigt'::text AND a.neigung = 6)) * b.ant_los3 + (( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 25 AND a.vk_sit = 'Land/Erschliessung/30/stop+go'::text AND a.neigung = 6)) * b.ant_los4) * 365::double precision / 1000::double precision
                    WHEN b.neigung = 0 AND b.vsit::text = 'Land/Erschliessung/40'::text THEN b.dtv2015_snf::double precision * ((( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 25 AND a.vk_sit = 'Land/Erschliessung/40/fluessig'::text AND a.neigung = 0)) * b.ant_los1 + (( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 25 AND a.vk_sit = 'Land/Erschliessung/40/dicht'::text AND a.neigung = 0)) * b.ant_los2 + (( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 25 AND a.vk_sit = 'Land/Erschliessung/40/gesaettigt'::text AND a.neigung = 0)) * b.ant_los3 + (( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 25 AND a.vk_sit = 'Land/Erschliessung/40/stop+go'::text AND a.neigung = 0)) * b.ant_los4) * 365::double precision / 1000::double precision
                    WHEN b.neigung = 2 AND b.vsit::text = 'Land/Erschliessung/40'::text THEN b.dtv2015_snf::double precision * ((( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 25 AND a.vk_sit = 'Land/Erschliessung/40/fluessig'::text AND a.neigung = 2)) * b.ant_los1 + (( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 25 AND a.vk_sit = 'Land/Erschliessung/40/dicht'::text AND a.neigung = 2)) * b.ant_los2 + (( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 25 AND a.vk_sit = 'Land/Erschliessung/40/gesaettigt'::text AND a.neigung = 2)) * b.ant_los3 + (( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 25 AND a.vk_sit = 'Land/Erschliessung/40/stop+go'::text AND a.neigung = 2)) * b.ant_los4) * 365::double precision / 1000::double precision
                    WHEN b.neigung = 4 AND b.vsit::text = 'Land/Erschliessung/40'::text THEN b.dtv2015_snf::double precision * ((( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 25 AND a.vk_sit = 'Land/Erschliessung/40/fluessig'::text AND a.neigung = 4)) * b.ant_los1 + (( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 25 AND a.vk_sit = 'Land/Erschliessung/40/dicht'::text AND a.neigung = 4)) * b.ant_los2 + (( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 25 AND a.vk_sit = 'Land/Erschliessung/40/gesaettigt'::text AND a.neigung = 4)) * b.ant_los3 + (( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 25 AND a.vk_sit = 'Land/Erschliessung/40/stop+go'::text AND a.neigung = 4)) * b.ant_los4) * 365::double precision / 1000::double precision
                    WHEN b.neigung = 6 AND b.vsit::text = 'Land/Erschliessung/40'::text THEN b.dtv2015_snf::double precision * ((( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 25 AND a.vk_sit = 'Land/Erschliessung/40/fluessig'::text AND a.neigung = 6)) * b.ant_los1 + (( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 25 AND a.vk_sit = 'Land/Erschliessung/40/dicht'::text AND a.neigung = 6)) * b.ant_los2 + (( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 25 AND a.vk_sit = 'Land/Erschliessung/40/gesaettigt'::text AND a.neigung = 6)) * b.ant_los3 + (( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 25 AND a.vk_sit = 'Land/Erschliessung/40/stop+go'::text AND a.neigung = 6)) * b.ant_los4) * 365::double precision / 1000::double precision
                    WHEN b.neigung = 0 AND b.vsit::text = 'Land/Erschliessung/50'::text THEN b.dtv2015_snf::double precision * ((( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                    ...
                    WHEN b.neigung = 0 AND b.vsit::text = 'Land/HVS/30'::text THEN b.dtv2015_snf::double precision * ((( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 25 AND a.vk_sit = 'Land/HVS/30/fluessig'::text AND a.neigung = 0)) * b.ant_los1 + (( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 25 AND a.vk_sit = 'Land/HVS/30/dicht'::text AND a.neigung = 0)) * b.ant_los2 + (( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 25 AND a.vk_sit = 'Land/HVS/30/gesaettigt'::text AND a.neigung = 0)) * b.ant_los3 + (( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 25 AND a.vk_sit = 'Land/HVS/30/stop+go'::text AND a.neigung = 0)) * b.ant_los4) * 365::double precision / 1000::double precision
                    WHEN b.neigung = 2 AND b.vsit::text = 'Land/HVS/30'::text THEN b.dtv2015_snf::double precision * ((( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 25 AND a.vk_sit = 'Land/HVS/30/fluessig'::text AND a.neigung = 2)) * b.ant_los1 + (( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 25 AND a.vk_sit = 'Land/HVS/30/dicht'::text AND a.neigung = 2)) * b.ant_los2 + (( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 25 AND a.vk_sit = 'Land/HVS/30/gesaettigt'::text AND a.neigung = 2)) * b.ant_los3 + (( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 25 AND a.vk_sit = 'Land/HVS/30/stop+go'::text AND a.neigung = 2)) * b.ant_los4) * 365::double precision / 1000::double precision
                    WHEN b.neigung = 4 AND b.vsit::text = 'Land/HVS/30'::text THEN b.dtv2015_snf::double precision * ((( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 25 AND a.vk_sit = 'Land/HVS/30/fluessig'::text AND a.neigung = 4)) * b.ant_los1 + (( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 25 AND a.vk_sit = 'Land/HVS/30/dicht'::text AND a.neigung = 4)) * b.ant_los2 + (( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 25 AND a.vk_sit = 'Land/HVS/30/gesaettigt'::text AND a.neigung = 4)) * b.ant_los3 + (( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 25 AND a.vk_sit = 'Land/HVS/30/stop+go'::text AND a.neigung = 4)) * b.ant_los4) * 365::double precision / 1000::double precision
                    WHEN b.neigung = 6 AND b.vsit::text = 'Land/HVS/30'::text THEN b.dtv2015_snf::double precision * ((( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 25 AND a.vk_sit = 'Land/HVS/30/fluessig'::text AND a.neigung = 6)) * b.ant_los1 + (( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 25 AND a.vk_sit = 'Land/HVS/30/dicht'::text AND a.neigung = 6)) * b.ant_los2 + (( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 25 AND a.vk_sit = 'Land/HVS/30/gesaettigt'::text AND a.neigung = 6)) * b.ant_los3 + (( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 25 AND a.vk_sit = 'Land/HVS/30/stop+go'::text AND a.neigung = 6)) * b.ant_los4) * 365::double precision / 1000::double precision
                    WHEN b.neigung = 0 AND b.vsit::text = 'Land/HVS/40'::text THEN b.dtv2015_snf::double precision * ((( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 25 AND a.vk_sit = 'Land/HVS/40/fluessig'::text AND a.neigung = 0)) * b.ant_los1 + (( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 25 AND a.vk_sit = 'Land/HVS/40/dicht'::text AND a.neigung = 0)) * b.ant_los2 + (( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 25 AND a.vk_sit = 'Land/HVS/40/gesaettigt'::text AND a.neigung = 0)) * b.ant_los3 + (( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 25 AND a.vk_sit = 'Land/HVS/40/stop+go'::text AND a.neigung = 0)) * b.ant_los4) * 365::double precision / 1000::double precision
                    WHEN b.neigung = 2 AND b.vsit::text = 'Land/HVS/40'::text THEN b.dtv2015_snf::double precision * ((( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 25 AND a.vk_sit = 'Land/HVS/40/fluessig'::text AND a.neigung = 2)) * b.ant_los1 + (( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 25 AND a.vk_sit = 'Land/HVS/40/dicht'::text AND a.neigung = 2)) * b.ant_los2 + (( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 25 AND a.vk_sit = 'Land/HVS/40/gesaettigt'::text AND a.neigung = 2)) * b.ant_los3 + (( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 25 AND a.vk_sit = 'Land/HVS/40/stop+go'::text AND a.neigung = 2)) * b.ant_los4) * 365::double precision / 1000::double precision
                    WHEN b.neigung = 4 AND b.vsit::text = 'Land/HVS/40'::text THEN b.dtv2015_snf::double precision * ((( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 25 AND a.vk_sit = 'Land/HVS/40/fluessig'::text AND a.neigung = 4)) * b.ant_los1 + (( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 25 AND a.vk_sit = 'Land/HVS/40/dicht'::text AND a.neigung = 4)) * b.ant_los2 + (( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 25 AND a.vk_sit = 'Land/HVS/40/gesaettigt'::text AND a.neigung = 4)) * b.ant_los3 + (( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 25 AND a.vk_sit = 'Land/HVS/40/stop+go'::text AND a.neigung = 4)) * b.ant_los4) * 365::double precision / 1000::double precision
                    WHEN b.neigung = 6 AND b.vsit::text = 'Land/HVS/40'::text THEN b.dtv2015_snf::double precision * ((( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 25 AND a.vk_sit = 'Land/HVS/40/fluessig'::text AND a.neigung = 6)) * b.ant_los1 + (( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 25 AND a.vk_sit = 'Land/HVS/40/dicht'::text AND a.neigung = 6)) * b.ant_los2 + (( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 25 AND a.vk_sit = 'Land/HVS/40/gesaettigt'::text AND a.neigung = 6)) * b.ant_los3 + (( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 25 AND a.vk_sit = 'Land/HVS/40/stop+go'::text AND a.neigung = 6)) * b.ant_los4) * 365::double precision / 1000::double precision
                    WHEN b.neigung = 0 AND b.vsit::text = 'Land/HVS/50'::text THEN b.dtv2015_snf::double precision * ((( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 25 AND a.vk_sit = 'Land/HVS/50/fluessig'::text AND a.neigung = 0)) * b.ant_los1 + (( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 25 AND a.vk_sit = 'Land/HVS/50/dicht'::text AND a.neigung = 0)) * b.ant_los2 + (( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 25 AND a.vk_sit = 'Land/HVS/50/gesaettigt'::text AND a.neigung = 0)) * b.ant_los3 + (( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 25 AND a.vk_sit = 'Land/HVS/50/stop+go'::text AND a.neigung = 0)) * b.ant_los4) * 365::double precision / 1000::double precision
                    WHEN b.neigung = 2 AND b.vsit::text = 'Land/HVS/50'::text THEN b.dtv2015_snf::double precision * ((( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 25 AND a.vk_sit = 'Land/HVS/50/fluessig'::text AND a.neigung = 2)) * b.ant_los1 + (( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 25 AND a.vk_sit = 'Land/HVS/50/dicht'::text AND a.neigung = 2)) * b.ant_los2 + (( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 25 AND a.vk_sit = 'Land/HVS/50/gesaettigt'::text AND a.neigung = 2)) * b.ant_los3 + (( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 25 AND a.vk_sit = 'Land/HVS/50/stop+go'::text AND a.neigung = 2)) * b.ant_los4) * 365::double precision / 1000::double precision
                    WHEN b.neigung = 4 AND b.vsit::text = 'Land/HVS/50'::text THEN b.dtv2015_snf::double precision * ((( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 25 AND a.vk_sit = 'Land/HVS/50/fluessig'::text AND a.neigung = 4)) * b.ant_los1 + (( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 25 AND a.vk_sit = 'Land/HVS/50/dicht'::text AND a.neigung = 4)) * b.ant_los2 + (( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 25 AND a.vk_sit = 'Land/HVS/50/gesaettigt'::text AND a.neigung = 4)) * b.ant_los3 + (( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 25 AND a.vk_sit = 'Land/HVS/50/stop+go'::text AND a.neigung = 4)) * b.ant_los4) * 365::double precision / 1000::double precision
                    WHEN b.neigung = 6 AND b.vsit::text = 'Land/HVS/50'::text THEN b.dtv2015_snf::double precision * ((( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 25 AND a.vk_sit = 'Land/HVS/50/fluessig'::text AND a.neigung = 6)) * b.ant_los1 + (( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 25 AND a.vk_sit = 'Land/HVS/50/dicht'::text AND a.neigung = 6)) * b.ant_los2 + (( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 25 AND a.vk_sit = 'Land/HVS/50/gesaettigt'::text AND a.neigung = 6)) * b.ant_los3 + (( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 25 AND a.vk_sit = 'Land/HVS/50/stop+go'::text AND a.neigung = 6)) * b.ant_los4) * 365::double precision / 1000::double precision
                    WHEN b.neigung = 0 AND b.vsit::text = 'Land/HVS/60'::text THEN b.dtv2015_snf::double precision * ((( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 25 AND a.vk_sit = 'Land/HVS/60/fluessig'::text AND a.neigung = 0)) * b.ant_los1 + (( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 25 AND a.vk_sit = 'Land/HVS/60/dicht'::text AND a.neigung = 0)) * b.ant_los2 + (( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 25 AND a.vk_sit = 'Land/HVS/60/gesaettigt'::text AND a.neigung = 0)) * b.ant_los3 + (( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 25 AND a.vk_sit = 'Land/HVS/60/stop+go'::text AND a.neigung = 0)) * b.ant_los4) * 365::double precision / 1000::double precision
                    WHEN b.neigung = 2 AND b.vsit::text = 'Land/HVS/60'::text THEN b.dtv2015_snf::double precision * ((( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 25 AND a.vk_sit = 'Land/HVS/60/fluessig'::text AND a.neigung = 2)) * b.ant_los1 + (( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 25 AND a.vk_sit = 'Land/HVS/60/dicht'::text AND a.neigung = 2)) * b.ant_los2 + (( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 25 AND a.vk_sit = 'Land/HVS/60/gesaettigt'::text AND a.neigung = 2)) * b.ant_los3 + (( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 25 AND a.vk_sit = 'Land/HVS/60/stop+go'::text AND a.neigung = 2)) * b.ant_los4) * 365::double precision / 1000::double precision
                    WHEN b.neigung = 4 AND b.vsit::text = 'Land/HVS/60'::text THEN b.dtv2015_snf::double precision * ((( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 25 AND a.vk_sit = 'Land/HVS/60/fluessig'::text AND a.neigung = 4)) * b.ant_los1 + (( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 25 AND a.vk_sit = 'Land/HVS/60/dicht'::text AND a.neigung = 4)) * b.ant_los2 + (( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 25 AND a.vk_sit = 'Land/HVS/60/gesaettigt'::text AND a.neigung = 4)) * b.ant_los3 + (( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 25 AND a.vk_sit = 'Land/HVS/60/stop+go'::text AND a.neigung = 4)) * b.ant_los4) * 365::double precision / 1000::double precision
                    WHEN b.neigung = 6 AND b.vsit::text = 'Land/HVS/60'::text THEN b.dtv2015_snf::double precision * ((( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 25 AND a.vk_sit = 'Land/HVS/60/fluessig'::text AND a.neigung = 6)) * b.ant_los1 + (( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 25 AND a.vk_sit = 'Land/HVS/60/dicht'::text AND a.neigung = 6)) * b.ant_los2 + (( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 25 AND a.vk_sit = 'Land/HVS/60/gesaettigt'::text AND a.neigung = 6)) * b.ant_los3 + (( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 25 AND a.vk_sit = 'Land/HVS/60/stop+go'::text AND a.neigung = 6)) * b.ant_los4) * 365::double precision / 1000::double precision
                    WHEN b.neigung = 0 AND b.vsit::text = 'Land/HVS/70'::text THEN b.dtv2015_snf::double precision * ((( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                    ...
                    WHEN b.neigung = 0 AND b.vsit::text = 'Land/Sammel/50'::text THEN b.dtv2015_snf::double precision * ((( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 25 AND a.vk_sit = 'Land/Sammel/50/fluessig'::text AND a.neigung = 0)) * b.ant_los1 + (( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 25 AND a.vk_sit = 'Land/Sammel/50/dicht'::text AND a.neigung = 0)) * b.ant_los2 + (( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 25 AND a.vk_sit = 'Land/Sammel/50/gesaettigt'::text AND a.neigung = 0)) * b.ant_los3 + (( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 25 AND a.vk_sit = 'Land/Sammel/50/stop+go'::text AND a.neigung = 0)) * b.ant_los4) * 365::double precision / 1000::double precision
                    WHEN b.neigung = 2 AND b.vsit::text = 'Land/Sammel/50'::text THEN b.dtv2015_snf::double precision * ((( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 25 AND a.vk_sit = 'Land/Sammel/50/fluessig'::text AND a.neigung = 2)) * b.ant_los1 + (( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 25 AND a.vk_sit = 'Land/Sammel/50/dicht'::text AND a.neigung = 2)) * b.ant_los2 + (( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 25 AND a.vk_sit = 'Land/Sammel/50/gesaettigt'::text AND a.neigung = 2)) * b.ant_los3 + (( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 25 AND a.vk_sit = 'Land/Sammel/50/stop+go'::text AND a.neigung = 2)) * b.ant_los4) * 365::double precision / 1000::double precision
                    WHEN b.neigung = 4 AND b.vsit::text = 'Land/Sammel/50'::text THEN b.dtv2015_snf::double precision * ((( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 25 AND a.vk_sit = 'Land/Sammel/50/fluessig'::text AND a.neigung = 4)) * b.ant_los1 + (( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 25 AND a.vk_sit = 'Land/Sammel/50/dicht'::text AND a.neigung = 4)) * b.ant_los2 + (( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 25 AND a.vk_sit = 'Land/Sammel/50/gesaettigt'::text AND a.neigung = 4)) * b.ant_los3 + (( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 25 AND a.vk_sit = 'Land/Sammel/50/stop+go'::text AND a.neigung = 4)) * b.ant_los4) * 365::double precision / 1000::double precision
                    WHEN b.neigung = 6 AND b.vsit::text = 'Land/Sammel/50'::text THEN b.dtv2015_snf::double precision * ((( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 25 AND a.vk_sit = 'Land/Sammel/50/fluessig'::text AND a.neigung = 6)) * b.ant_los1 + (( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 25 AND a.vk_sit = 'Land/Sammel/50/dicht'::text AND a.neigung = 6)) * b.ant_los2 + (( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 25 AND a.vk_sit = 'Land/Sammel/50/gesaettigt'::text AND a.neigung = 6)) * b.ant_los3 + (( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 25 AND a.vk_sit = 'Land/Sammel/50/stop+go'::text AND a.neigung = 6)) * b.ant_los4) * 365::double precision / 1000::double precision
                    WHEN b.neigung = 0 AND b.vsit::text = 'Land/Sammel/60'::text THEN b.dtv2015_snf::double precision * ((( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                ...
                CASE
                    ...
                    WHEN b.neigung = 0 AND b.vsit::text = 'Land/Erschliessung/30'::text THEN b.dtv2015_snf::double precision * ((( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 2 AND a.vk_sit = 'Land/Erschliessung/30/fluessig'::text AND a.neigung = 0)) * b.ant_los1 + (( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 2 AND a.vk_sit = 'Land/Erschliessung/30/dicht'::text AND a.neigung = 0)) * b.ant_los2 + (( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 2 AND a.vk_sit = 'Land/Erschliessung/30/gesaettigt'::text AND a.neigung = 0)) * b.ant_los3 + (( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 2 AND a.vk_sit = 'Land/Erschliessung/30/stop+go'::text AND a.neigung = 0)) * b.ant_los4) * 365::double precision / 1000::double precision
                    WHEN b.neigung = 2 AND b.vsit::text = 'Land/Erschliessung/30'::text THEN b.dtv2015_snf::double precision * ((( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 2 AND a.vk_sit = 'Land/Erschliessung/30/fluessig'::text AND a.neigung = 2)) * b.ant_los1 + (( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 2 AND a.vk_sit = 'Land/Erschliessung/30/dicht'::text AND a.neigung = 2)) * b.ant_los2 + (( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 2 AND a.vk_sit = 'Land/Erschliessung/30/gesaettigt'::text AND a.neigung = 2)) * b.ant_los3 + (( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 2 AND a.vk_sit = 'Land/Erschliessung/30/stop+go'::text AND a.neigung = 2)) * b.ant_los4) * 365::double precision / 1000::double precision
                    WHEN b.neigung = 4 AND b.vsit::text = 'Land/Erschliessung/30'::text THEN b.dtv2015_snf::double precision * ((( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 2 AND a.vk_sit = 'Land/Erschliessung/30/fluessig'::text AND a.neigung = 4)) * b.ant_los1 + (( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 2 AND a.vk_sit = 'Land/Erschliessung/30/dicht'::text AND a.neigung = 4)) * b.ant_los2 + (( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 2 AND a.vk_sit = 'Land/Erschliessung/30/gesaettigt'::text AND a.neigung = 4)) * b.ant_los3 + (( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 2 AND a.vk_sit = 'Land/Erschliessung/30/stop+go'::text AND a.neigung = 4)) * b.ant_los4) * 365::double precision / 1000::double precision
                    WHEN b.neigung = 6 AND b.vsit::text = 'Land/Erschliessung/30'::text THEN b.dtv2015_snf::double precision * ((( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 2 AND a.vk_sit = 'Land/Erschliessung/30/fluessig'::text AND a.neigung = 6)) * b.ant_los1 + (( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 2 AND a.vk_sit = 'Land/Erschliessung/30/dicht'::text AND a.neigung = 6)) * b.ant_los2 + (( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 2 AND a.vk_sit = 'Land/Erschliessung/30/gesaettigt'::text AND a.neigung = 6)) * b.ant_los3 + (( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 2 AND a.vk_sit = 'Land/Erschliessung/30/stop+go'::text AND a.neigung = 6)) * b.ant_los4) * 365::double precision / 1000::double precision
                    WHEN b.neigung = 0 AND b.vsit::text = 'Land/Erschliessung/40'::text THEN b.dtv2015_snf::double precision * ((( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 2 AND a.vk_sit = 'Land/Erschliessung/40/fluessig'::text AND a.neigung = 0)) * b.ant_los1 + (( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 2 AND a.vk_sit = 'Land/Erschliessung/40/dicht'::text AND a.neigung = 0)) * b.ant_los2 + (( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 2 AND a.vk_sit = 'Land/Erschliessung/40/gesaettigt'::text AND a.neigung = 0)) * b.ant_los3 + (( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 2 AND a.vk_sit = 'Land/Erschliessung/40/stop+go'::text AND a.neigung = 0)) * b.ant_los4) * 365::double precision / 1000::double precision
                    WHEN b.neigung = 2 AND b.vsit::text = 'Land/Erschliessung/40'::text THEN b.dtv2015_snf::double precision * ((( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 2 AND a.vk_sit = 'Land/Erschliessung/40/fluessig'::text AND a.neigung = 2)) * b.ant_los1 + (( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 2 AND a.vk_sit = 'Land/Erschliessung/40/dicht'::text AND a.neigung = 2)) * b.ant_los2 + (( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 2 AND a.vk_sit = 'Land/Erschliessung/40/gesaettigt'::text AND a.neigung = 2)) * b.ant_los3 + (( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 2 AND a.vk_sit = 'Land/Erschliessung/40/stop+go'::text AND a.neigung = 2)) * b.ant_los4) * 365::double precision / 1000::double precision
                    WHEN b.neigung = 4 AND b.vsit::text = 'Land/Erschliessung/40'::text THEN b.dtv2015_snf::double precision * ((( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 2 AND a.vk_sit = 'Land/Erschliessung/40/fluessig'::text AND a.neigung = 4)) * b.ant_los1 + (( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 2 AND a.vk_sit = 'Land/Erschliessung/40/dicht'::text AND a.neigung = 4)) * b.ant_los2 + (( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 2 AND a.vk_sit = 'Land/Erschliessung/40/gesaettigt'::text AND a.neigung = 4)) * b.ant_los3 + (( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 2 AND a.vk_sit = 'Land/Erschliessung/40/stop+go'::text AND a.neigung = 4)) * b.ant_los4) * 365::double precision / 1000::double precision
                    WHEN b.neigung = 6 AND b.vsit::text = 'Land/Erschliessung/40'::text THEN b.dtv2015_snf::double precision * ((( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 2 AND a.vk_sit = 'Land/Erschliessung/40/fluessig'::text AND a.neigung = 6)) * b.ant_los1 + (( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 2 AND a.vk_sit = 'Land/Erschliessung/40/dicht'::text AND a.neigung = 6)) * b.ant_los2 + (( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 2 AND a.vk_sit = 'Land/Erschliessung/40/gesaettigt'::text AND a.neigung = 6)) * b.ant_los3 + (( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 2 AND a.vk_sit = 'Land/Erschliessung/40/stop+go'::text AND a.neigung = 6)) * b.ant_los4) * 365::double precision / 1000::double precision
                    WHEN b.neigung = 0 AND b.vsit::text = 'Land/Erschliessung/50'::text THEN b.dtv2015_snf::double precision * ((( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                    ...
                    WHEN b.neigung = 0 AND b.vsit::text = 'Land/HVS/30'::text THEN b.dtv2015_snf::double precision * ((( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 2 AND a.vk_sit = 'Land/HVS/30/fluessig'::text AND a.neigung = 0)) * b.ant_los1 + (( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 2 AND a.vk_sit = 'Land/HVS/30/dicht'::text AND a.neigung = 0)) * b.ant_los2 + (( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 2 AND a.vk_sit = 'Land/HVS/30/gesaettigt'::text AND a.neigung = 0)) * b.ant_los3 + (( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 2 AND a.vk_sit = 'Land/HVS/30/stop+go'::text AND a.neigung = 0)) * b.ant_los4) * 365::double precision / 1000::double precision
                    WHEN b.neigung = 2 AND b.vsit::text = 'Land/HVS/30'::text THEN b.dtv2015_snf::double precision * ((( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 2 AND a.vk_sit = 'Land/HVS/30/fluessig'::text AND a.neigung = 2)) * b.ant_los1 + (( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 2 AND a.vk_sit = 'Land/HVS/30/dicht'::text AND a.neigung = 2)) * b.ant_los2 + (( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 2 AND a.vk_sit = 'Land/HVS/30/gesaettigt'::text AND a.neigung = 2)) * b.ant_los3 + (( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 2 AND a.vk_sit = 'Land/HVS/30/stop+go'::text AND a.neigung = 2)) * b.ant_los4) * 365::double precision / 1000::double precision
                    WHEN b.neigung = 4 AND b.vsit::text = 'Land/HVS/30'::text THEN b.dtv2015_snf::double precision * ((( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 2 AND a.vk_sit = 'Land/HVS/30/fluessig'::text AND a.neigung = 4)) * b.ant_los1 + (( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 2 AND a.vk_sit = 'Land/HVS/30/dicht'::text AND a.neigung = 4)) * b.ant_los2 + (( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 2 AND a.vk_sit = 'Land/HVS/30/gesaettigt'::text AND a.neigung = 4)) * b.ant_los3 + (( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 2 AND a.vk_sit = 'Land/HVS/30/stop+go'::text AND a.neigung = 4)) * b.ant_los4) * 365::double precision / 1000::double precision
                    WHEN b.neigung = 6 AND b.vsit::text = 'Land/HVS/30'::text THEN b.dtv2015_snf::double precision * ((( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 2 AND a.vk_sit = 'Land/HVS/30/fluessig'::text AND a.neigung = 6)) * b.ant_los1 + (( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 2 AND a.vk_sit = 'Land/HVS/30/dicht'::text AND a.neigung = 6)) * b.ant_los2 + (( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 2 AND a.vk_sit = 'Land/HVS/30/gesaettigt'::text AND a.neigung = 6)) * b.ant_los3 + (( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 2 AND a.vk_sit = 'Land/HVS/30/stop+go'::text AND a.neigung = 6)) * b.ant_los4) * 365::double precision / 1000::double precision
                    WHEN b.neigung = 0 AND b.vsit::text = 'Land/HVS/40'::text THEN b.dtv2015_snf::double precision * ((( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 2 AND a.vk_sit = 'Land/HVS/40/fluessig'::text AND a.neigung = 0)) * b.ant_los1 + (( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 2 AND a.vk_sit = 'Land/HVS/40/dicht'::text AND a.neigung = 0)) * b.ant_los2 + (( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 2 AND a.vk_sit = 'Land/HVS/40/gesaettigt'::text AND a.neigung = 0)) * b.ant_los3 + (( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 2 AND a.vk_sit = 'Land/HVS/40/stop+go'::text AND a.neigung = 0)) * b.ant_los4) * 365::double precision / 1000::double precision
                    WHEN b.neigung = 2 AND b.vsit::text = 'Land/HVS/40'::text THEN b.dtv2015_snf::double precision * ((( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 2 AND a.vk_sit = 'Land/HVS/40/fluessig'::text AND a.neigung = 2)) * b.ant_los1 + (( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 2 AND a.vk_sit = 'Land/HVS/40/dicht'::text AND a.neigung = 2)) * b.ant_los2 + (( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 2 AND a.vk_sit = 'Land/HVS/40/gesaettigt'::text AND a.neigung = 2)) * b.ant_los3 + (( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 2 AND a.vk_sit = 'Land/HVS/40/stop+go'::text AND a.neigung = 2)) * b.ant_los4) * 365::double precision / 1000::double precision
                    WHEN b.neigung = 4 AND b.vsit::text = 'Land/HVS/40'::text THEN b.dtv2015_snf::double precision * ((( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 2 AND a.vk_sit = 'Land/HVS/40/fluessig'::text AND a.neigung = 4)) * b.ant_los1 + (( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 2 AND a.vk_sit = 'Land/HVS/40/dicht'::text AND a.neigung = 4)) * b.ant_los2 + (( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 2 AND a.vk_sit = 'Land/HVS/40/gesaettigt'::text AND a.neigung = 4)) * b.ant_los3 + (( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 2 AND a.vk_sit = 'Land/HVS/40/stop+go'::text AND a.neigung = 4)) * b.ant_los4) * 365::double precision / 1000::double precision
                    WHEN b.neigung = 6 AND b.vsit::text = 'Land/HVS/40'::text THEN b.dtv2015_snf::double precision * ((( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 2 AND a.vk_sit = 'Land/HVS/40/fluessig'::text AND a.neigung = 6)) * b.ant_los1 + (( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 2 AND a.vk_sit = 'Land/HVS/40/dicht'::text AND a.neigung = 6)) * b.ant_los2 + (( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 2 AND a.vk_sit = 'Land/HVS/40/gesaettigt'::text AND a.neigung = 6)) * b.ant_los3 + (( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 2 AND a.vk_sit = 'Land/HVS/40/stop+go'::text AND a.neigung = 6)) * b.ant_los4) * 365::double precision / 1000::double precision
                    WHEN b.neigung = 0 AND b.vsit::text = 'Land/HVS/50'::text THEN b.dtv2015_snf::double precision * ((( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 2 AND a.vk_sit = 'Land/HVS/50/fluessig'::text AND a.neigung = 0)) * b.ant_los1 + (( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 2 AND a.vk_sit = 'Land/HVS/50/dicht'::text AND a.neigung = 0)) * b.ant_los2 + (( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 2 AND a.vk_sit = 'Land/HVS/50/gesaettigt'::text AND a.neigung = 0)) * b.ant_los3 + (( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 2 AND a.vk_sit = 'Land/HVS/50/stop+go'::text AND a.neigung = 0)) * b.ant_los4) * 365::double precision / 1000::double precision
                    WHEN b.neigung = 2 AND b.vsit::text = 'Land/HVS/50'::text THEN b.dtv2015_snf::double precision * ((( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 2 AND a.vk_sit = 'Land/HVS/50/fluessig'::text AND a.neigung = 2)) * b.ant_los1 + (( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 2 AND a.vk_sit = 'Land/HVS/50/dicht'::text AND a.neigung = 2)) * b.ant_los2 + (( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 2 AND a.vk_sit = 'Land/HVS/50/gesaettigt'::text AND a.neigung = 2)) * b.ant_los3 + (( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 2 AND a.vk_sit = 'Land/HVS/50/stop+go'::text AND a.neigung = 2)) * b.ant_los4) * 365::double precision / 1000::double precision
                    WHEN b.neigung = 4 AND b.vsit::text = 'Land/HVS/50'::text THEN b.dtv2015_snf::double precision * ((( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 2 AND a.vk_sit = 'Land/HVS/50/fluessig'::text AND a.neigung = 4)) * b.ant_los1 + (( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 2 AND a.vk_sit = 'Land/HVS/50/dicht'::text AND a.neigung = 4)) * b.ant_los2 + (( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 2 AND a.vk_sit = 'Land/HVS/50/gesaettigt'::text AND a.neigung = 4)) * b.ant_los3 + (( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 2 AND a.vk_sit = 'Land/HVS/50/stop+go'::text AND a.neigung = 4)) * b.ant_los4) * 365::double precision / 1000::double precision
                    WHEN b.neigung = 6 AND b.vsit::text = 'Land/HVS/50'::text THEN b.dtv2015_snf::double precision * ((( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 2 AND a.vk_sit = 'Land/HVS/50/fluessig'::text AND a.neigung = 6)) * b.ant_los1 + (( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 2 AND a.vk_sit = 'Land/HVS/50/dicht'::text AND a.neigung = 6)) * b.ant_los2 + (( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 2 AND a.vk_sit = 'Land/HVS/50/gesaettigt'::text AND a.neigung = 6)) * b.ant_los3 + (( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 2 AND a.vk_sit = 'Land/HVS/50/stop+go'::text AND a.neigung = 6)) * b.ant_los4) * 365::double precision / 1000::double precision
                    WHEN b.neigung = 0 AND b.vsit::text = 'Land/HVS/60'::text THEN b.dtv2015_snf::double precision * ((( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 2 AND a.vk_sit = 'Land/HVS/60/fluessig'::text AND a.neigung = 0)) * b.ant_los1 + (( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 2 AND a.vk_sit = 'Land/HVS/60/dicht'::text AND a.neigung = 0)) * b.ant_los2 + (( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 2 AND a.vk_sit = 'Land/HVS/60/gesaettigt'::text AND a.neigung = 0)) * b.ant_los3 + (( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 2 AND a.vk_sit = 'Land/HVS/60/stop+go'::text AND a.neigung = 0)) * b.ant_los4) * 365::double precision / 1000::double precision
                    WHEN b.neigung = 2 AND b.vsit::text = 'Land/HVS/60'::text THEN b.dtv2015_snf::double precision * ((( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 2 AND a.vk_sit = 'Land/HVS/60/fluessig'::text AND a.neigung = 2)) * b.ant_los1 + (( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 2 AND a.vk_sit = 'Land/HVS/60/dicht'::text AND a.neigung = 2)) * b.ant_los2 + (( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 2 AND a.vk_sit = 'Land/HVS/60/gesaettigt'::text AND a.neigung = 2)) * b.ant_los3 + (( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 2 AND a.vk_sit = 'Land/HVS/60/stop+go'::text AND a.neigung = 2)) * b.ant_los4) * 365::double precision / 1000::double precision
                    WHEN b.neigung = 4 AND b.vsit::text = 'Land/HVS/60'::text THEN b.dtv2015_snf::double precision * ((( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 2 AND a.vk_sit = 'Land/HVS/60/fluessig'::text AND a.neigung = 4)) * b.ant_los1 + (( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 2 AND a.vk_sit = 'Land/HVS/60/dicht'::text AND a.neigung = 4)) * b.ant_los2 + (( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 2 AND a.vk_sit = 'Land/HVS/60/gesaettigt'::text AND a.neigung = 4)) * b.ant_los3 + (( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 2 AND a.vk_sit = 'Land/HVS/60/stop+go'::text AND a.neigung = 4)) * b.ant_los4) * 365::double precision / 1000::double precision
                    WHEN b.neigung = 6 AND b.vsit::text = 'Land/HVS/60'::text THEN b.dtv2015_snf::double precision * ((( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 2 AND a.vk_sit = 'Land/HVS/60/fluessig'::text AND a.neigung = 6)) * b.ant_los1 + (( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 2 AND a.vk_sit = 'Land/HVS/60/dicht'::text AND a.neigung = 6)) * b.ant_los2 + (( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 2 AND a.vk_sit = 'Land/HVS/60/gesaettigt'::text AND a.neigung = 6)) * b.ant_los3 + (( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 2 AND a.vk_sit = 'Land/HVS/60/stop+go'::text AND a.neigung = 6)) * b.ant_los4) * 365::double precision / 1000::double precision
                    WHEN b.neigung = 0 AND b.vsit::text = 'Land/HVS/70'::text THEN b.dtv2015_snf::double precision * ((( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                    ...
                    WHEN b.neigung = 0 AND b.vsit::text = 'Land/Sammel/50'::text THEN b.dtv2015_snf::double precision * ((( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 2 AND a.vk_sit = 'Land/Sammel/50/fluessig'::text AND a.neigung = 0)) * b.ant_los1 + (( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 2 AND a.vk_sit = 'Land/Sammel/50/dicht'::text AND a.neigung = 0)) * b.ant_los2 + (( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 2 AND a.vk_sit = 'Land/Sammel/50/gesaettigt'::text AND a.neigung = 0)) * b.ant_los3 + (( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 2 AND a.vk_sit = 'Land/Sammel/50/stop+go'::text AND a.neigung = 0)) * b.ant_los4) * 365::double precision / 1000::double precision
                    WHEN b.neigung = 2 AND b.vsit::text = 'Land/Sammel/50'::text THEN b.dtv2015_snf::double precision * ((( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 2 AND a.vk_sit = 'Land/Sammel/50/fluessig'::text AND a.neigung = 2)) * b.ant_los1 + (( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 2 AND a.vk_sit = 'Land/Sammel/50/dicht'::text AND a.neigung = 2)) * b.ant_los2 + (( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 2 AND a.vk_sit = 'Land/Sammel/50/gesaettigt'::text AND a.neigung = 2)) * b.ant_los3 + (( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 2 AND a.vk_sit = 'Land/Sammel/50/stop+go'::text AND a.neigung = 2)) * b.ant_los4) * 365::double precision / 1000::double precision
                    WHEN b.neigung = 4 AND b.vsit::text = 'Land/Sammel/50'::text THEN b.dtv2015_snf::double precision * ((( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 2 AND a.vk_sit = 'Land/Sammel/50/fluessig'::text AND a.neigung = 4)) * b.ant_los1 + (( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 2 AND a.vk_sit = 'Land/Sammel/50/dicht'::text AND a.neigung = 4)) * b.ant_los2 + (( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 2 AND a.vk_sit = 'Land/Sammel/50/gesaettigt'::text AND a.neigung = 4)) * b.ant_los3 + (( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 2 AND a.vk_sit = 'Land/Sammel/50/stop+go'::text AND a.neigung = 4)) * b.ant_los4) * 365::double precision / 1000::double precision
                    WHEN b.neigung = 6 AND b.vsit::text = 'Land/Sammel/50'::text THEN b.dtv2015_snf::double precision * ((( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 2 AND a.vk_sit = 'Land/Sammel/50/fluessig'::text AND a.neigung = 6)) * b.ant_los1 + (( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 2 AND a.vk_sit = 'Land/Sammel/50/dicht'::text AND a.neigung = 6)) * b.ant_los2 + (( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 2 AND a.vk_sit = 'Land/Sammel/50/gesaettigt'::text AND a.neigung = 6)) * b.ant_los3 + (( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 2 AND a.vk_sit = 'Land/Sammel/50/stop+go'::text AND a.neigung = 6)) * b.ant_los4) * 365::double precision / 1000::double precision
                    WHEN b.neigung = 0 AND b.vsit::text = 'Land/Sammel/60'::text THEN b.dtv2015_snf::double precision * ((( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                ...
                CASE
                    ...
                    WHEN b.neigung = 0 AND b.vsit::text = 'Land/Erschliessung/30'::text THEN b.dtv2015_snf::double precision * ((( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 1 AND a.vk_sit = 'Land/Erschliessung/30/fluessig'::text AND a.neigung = 0)) * b.ant_los1 + (( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 1 AND a.vk_sit = 'Land/Erschliessung/30/dicht'::text AND a.neigung = 0)) * b.ant_los2 + (( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 1 AND a.vk_sit = 'Land/Erschliessung/30/gesaettigt'::text AND a.neigung = 0)) * b.ant_los3 + (( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 1 AND a.vk_sit = 'Land/Erschliessung/30/stop+go'::text AND a.neigung = 0)) * b.ant_los4) * 365::double precision / 1000::double precision
                    WHEN b.neigung = 2 AND b.vsit::text = 'Land/Erschliessung/30'::text THEN b.dtv2015_snf::double precision * ((( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 1 AND a.vk_sit = 'Land/Erschliessung/30/fluessig'::text AND a.neigung = 2)) * b.ant_los1 + (( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 1 AND a.vk_sit = 'Land/Erschliessung/30/dicht'::text AND a.neigung = 2)) * b.ant_los2 + (( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 1 AND a.vk_sit = 'Land/Erschliessung/30/gesaettigt'::text AND a.neigung = 2)) * b.ant_los3 + (( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 1 AND a.vk_sit = 'Land/Erschliessung/30/stop+go'::text AND a.neigung = 2)) * b.ant_los4) * 365::double precision / 1000::double precision
                    WHEN b.neigung = 4 AND b.vsit::text = 'Land/Erschliessung/30'::text THEN b.dtv2015_snf::double precision * ((( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 1 AND a.vk_sit = 'Land/Erschliessung/30/fluessig'::text AND a.neigung = 4)) * b.ant_los1 + (( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 1 AND a.vk_sit = 'Land/Erschliessung/30/dicht'::text AND a.neigung = 4)) * b.ant_los2 + (( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 1 AND a.vk_sit = 'Land/Erschliessung/30/gesaettigt'::text AND a.neigung = 4)) * b.ant_los3 + (( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 1 AND a.vk_sit = 'Land/Erschliessung/30/stop+go'::text AND a.neigung = 4)) * b.ant_los4) * 365::double precision / 1000::double precision
                    WHEN b.neigung = 6 AND b.vsit::text = 'Land/Erschliessung/30'::text THEN b.dtv2015_snf::double precision * ((( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 1 AND a.vk_sit = 'Land/Erschliessung/30/fluessig'::text AND a.neigung = 6)) * b.ant_los1 + (( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 1 AND a.vk_sit = 'Land/Erschliessung/30/dicht'::text AND a.neigung = 6)) * b.ant_los2 + (( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 1 AND a.vk_sit = 'Land/Erschliessung/30/gesaettigt'::text AND a.neigung = 6)) * b.ant_los3 + (( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 1 AND a.vk_sit = 'Land/Erschliessung/30/stop+go'::text AND a.neigung = 6)) * b.ant_los4) * 365::double precision / 1000::double precision
                    WHEN b.neigung = 0 AND b.vsit::text = 'Land/Erschliessung/40'::text THEN b.dtv2015_snf::double precision * ((( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 1 AND a.vk_sit = 'Land/Erschliessung/40/fluessig'::text AND a.neigung = 0)) * b.ant_los1 + (( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 1 AND a.vk_sit = 'Land/Erschliessung/40/dicht'::text AND a.neigung = 0)) * b.ant_los2 + (( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 1 AND a.vk_sit = 'Land/Erschliessung/40/gesaettigt'::text AND a.neigung = 0)) * b.ant_los3 + (( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 1 AND a.vk_sit = 'Land/Erschliessung/40/stop+go'::text AND a.neigung = 0)) * b.ant_los4) * 365::double precision / 1000::double precision
                    WHEN b.neigung = 2 AND b.vsit::text = 'Land/Erschliessung/40'::text THEN b.dtv2015_snf::double precision * ((( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 1 AND a.vk_sit = 'Land/Erschliessung/40/fluessig'::text AND a.neigung = 2)) * b.ant_los1 + (( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 1 AND a.vk_sit = 'Land/Erschliessung/40/dicht'::text AND a.neigung = 2)) * b.ant_los2 + (( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 1 AND a.vk_sit = 'Land/Erschliessung/40/gesaettigt'::text AND a.neigung = 2)) * b.ant_los3 + (( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 1 AND a.vk_sit = 'Land/Erschliessung/40/stop+go'::text AND a.neigung = 2)) * b.ant_los4) * 365::double precision / 1000::double precision
                    WHEN b.neigung = 4 AND b.vsit::text = 'Land/Erschliessung/40'::text THEN b.dtv2015_snf::double precision * ((( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 1 AND a.vk_sit = 'Land/Erschliessung/40/fluessig'::text AND a.neigung = 4)) * b.ant_los1 + (( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 1 AND a.vk_sit = 'Land/Erschliessung/40/dicht'::text AND a.neigung = 4)) * b.ant_los2 + (( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 1 AND a.vk_sit = 'Land/Erschliessung/40/gesaettigt'::text AND a.neigung = 4)) * b.ant_los3 + (( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 1 AND a.vk_sit = 'Land/Erschliessung/40/stop+go'::text AND a.neigung = 4)) * b.ant_los4) * 365::double precision / 1000::double precision
                    WHEN b.neigung = 6 AND b.vsit::text = 'Land/Erschliessung/40'::text THEN b.dtv2015_snf::double precision * ((( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 1 AND a.vk_sit = 'Land/Erschliessung/40/fluessig'::text AND a.neigung = 6)) * b.ant_los1 + (( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 1 AND a.vk_sit = 'Land/Erschliessung/40/dicht'::text AND a.neigung = 6)) * b.ant_los2 + (( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 1 AND a.vk_sit = 'Land/Erschliessung/40/gesaettigt'::text AND a.neigung = 6)) * b.ant_los3 + (( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 1 AND a.vk_sit = 'Land/Erschliessung/40/stop+go'::text AND a.neigung = 6)) * b.ant_los4) * 365::double precision / 1000::double precision
                    WHEN b.neigung = 0 AND b.vsit::text = 'Land/Erschliessung/50'::text THEN b.dtv2015_snf::double precision * ((( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                    ...
                    WHEN b.neigung = 0 AND b.vsit::text = 'Land/HVS/30'::text THEN b.dtv2015_snf::double precision * ((( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 1 AND a.vk_sit = 'Land/HVS/30/fluessig'::text AND a.neigung = 0)) * b.ant_los1 + (( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 1 AND a.vk_sit = 'Land/HVS/30/dicht'::text AND a.neigung = 0)) * b.ant_los2 + (( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 1 AND a.vk_sit = 'Land/HVS/30/gesaettigt'::text AND a.neigung = 0)) * b.ant_los3 + (( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 1 AND a.vk_sit = 'Land/HVS/30/stop+go'::text AND a.neigung = 0)) * b.ant_los4) * 365::double precision / 1000::double precision
                    WHEN b.neigung = 2 AND b.vsit::text = 'Land/HVS/30'::text THEN b.dtv2015_snf::double precision * ((( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 1 AND a.vk_sit = 'Land/HVS/30/fluessig'::text AND a.neigung = 2)) * b.ant_los1 + (( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 1 AND a.vk_sit = 'Land/HVS/30/dicht'::text AND a.neigung = 2)) * b.ant_los2 + (( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 1 AND a.vk_sit = 'Land/HVS/30/gesaettigt'::text AND a.neigung = 2)) * b.ant_los3 + (( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 1 AND a.vk_sit = 'Land/HVS/30/stop+go'::text AND a.neigung = 2)) * b.ant_los4) * 365::double precision / 1000::double precision
                    WHEN b.neigung = 4 AND b.vsit::text = 'Land/HVS/30'::text THEN b.dtv2015_snf::double precision * ((( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 1 AND a.vk_sit = 'Land/HVS/30/fluessig'::text AND a.neigung = 4)) * b.ant_los1 + (( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 1 AND a.vk_sit = 'Land/HVS/30/dicht'::text AND a.neigung = 4)) * b.ant_los2 + (( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 1 AND a.vk_sit = 'Land/HVS/30/gesaettigt'::text AND a.neigung = 4)) * b.ant_los3 + (( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 1 AND a.vk_sit = 'Land/HVS/30/stop+go'::text AND a.neigung = 4)) * b.ant_los4) * 365::double precision / 1000::double precision
                    WHEN b.neigung = 6 AND b.vsit::text = 'Land/HVS/30'::text THEN b.dtv2015_snf::double precision * ((( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 1 AND a.vk_sit = 'Land/HVS/30/fluessig'::text AND a.neigung = 6)) * b.ant_los1 + (( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 1 AND a.vk_sit = 'Land/HVS/30/dicht'::text AND a.neigung = 6)) * b.ant_los2 + (( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 1 AND a.vk_sit = 'Land/HVS/30/gesaettigt'::text AND a.neigung = 6)) * b.ant_los3 + (( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 1 AND a.vk_sit = 'Land/HVS/30/stop+go'::text AND a.neigung = 6)) * b.ant_los4) * 365::double precision / 1000::double precision
                    WHEN b.neigung = 0 AND b.vsit::text = 'Land/HVS/40'::text THEN b.dtv2015_snf::double precision * ((( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 1 AND a.vk_sit = 'Land/HVS/40/fluessig'::text AND a.neigung = 0)) * b.ant_los1 + (( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 1 AND a.vk_sit = 'Land/HVS/40/dicht'::text AND a.neigung = 0)) * b.ant_los2 + (( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 1 AND a.vk_sit = 'Land/HVS/40/gesaettigt'::text AND a.neigung = 0)) * b.ant_los3 + (( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 1 AND a.vk_sit = 'Land/HVS/40/stop+go'::text AND a.neigung = 0)) * b.ant_los4) * 365::double precision / 1000::double precision
                    WHEN b.neigung = 2 AND b.vsit::text = 'Land/HVS/40'::text THEN b.dtv2015_snf::double precision * ((( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 1 AND a.vk_sit = 'Land/HVS/40/fluessig'::text AND a.neigung = 2)) * b.ant_los1 + (( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 1 AND a.vk_sit = 'Land/HVS/40/dicht'::text AND a.neigung = 2)) * b.ant_los2 + (( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 1 AND a.vk_sit = 'Land/HVS/40/gesaettigt'::text AND a.neigung = 2)) * b.ant_los3 + (( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 1 AND a.vk_sit = 'Land/HVS/40/stop+go'::text AND a.neigung = 2)) * b.ant_los4) * 365::double precision / 1000::double precision
                    WHEN b.neigung = 4 AND b.vsit::text = 'Land/HVS/40'::text THEN b.dtv2015_snf::double precision * ((( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 1 AND a.vk_sit = 'Land/HVS/40/fluessig'::text AND a.neigung = 4)) * b.ant_los1 + (( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 1 AND a.vk_sit = 'Land/HVS/40/dicht'::text AND a.neigung = 4)) * b.ant_los2 + (( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 1 AND a.vk_sit = 'Land/HVS/40/gesaettigt'::text AND a.neigung = 4)) * b.ant_los3 + (( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 1 AND a.vk_sit = 'Land/HVS/40/stop+go'::text AND a.neigung = 4)) * b.ant_los4) * 365::double precision / 1000::double precision
                    WHEN b.neigung = 6 AND b.vsit::text = 'Land/HVS/40'::text THEN b.dtv2015_snf::double precision * ((( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 1 AND a.vk_sit = 'Land/HVS/40/fluessig'::text AND a.neigung = 6)) * b.ant_los1 + (( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 1 AND a.vk_sit = 'Land/HVS/40/dicht'::text AND a.neigung = 6)) * b.ant_los2 + (( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 1 AND a.vk_sit = 'Land/HVS/40/gesaettigt'::text AND a.neigung = 6)) * b.ant_los3 + (( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 1 AND a.vk_sit = 'Land/HVS/40/stop+go'::text AND a.neigung = 6)) * b.ant_los4) * 365::double precision / 1000::double precision
                    WHEN b.neigung = 0 AND b.vsit::text = 'Land/HVS/50'::text THEN b.dtv2015_snf::double precision * ((( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 1 AND a.vk_sit = 'Land/HVS/50/fluessig'::text AND a.neigung = 0)) * b.ant_los1 + (( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 1 AND a.vk_sit = 'Land/HVS/50/dicht'::text AND a.neigung = 0)) * b.ant_los2 + (( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 1 AND a.vk_sit = 'Land/HVS/50/gesaettigt'::text AND a.neigung = 0)) * b.ant_los3 + (( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 1 AND a.vk_sit = 'Land/HVS/50/stop+go'::text AND a.neigung = 0)) * b.ant_los4) * 365::double precision / 1000::double precision
                    WHEN b.neigung = 2 AND b.vsit::text = 'Land/HVS/50'::text THEN b.dtv2015_snf::double precision * ((( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 1 AND a.vk_sit = 'Land/HVS/50/fluessig'::text AND a.neigung = 2)) * b.ant_los1 + (( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 1 AND a.vk_sit = 'Land/HVS/50/dicht'::text AND a.neigung = 2)) * b.ant_los2 + (( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 1 AND a.vk_sit = 'Land/HVS/50/gesaettigt'::text AND a.neigung = 2)) * b.ant_los3 + (( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 1 AND a.vk_sit = 'Land/HVS/50/stop+go'::text AND a.neigung = 2)) * b.ant_los4) * 365::double precision / 1000::double precision
                    WHEN b.neigung = 4 AND b.vsit::text = 'Land/HVS/50'::text THEN b.dtv2015_snf::double precision * ((( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 1 AND a.vk_sit = 'Land/HVS/50/fluessig'::text AND a.neigung = 4)) * b.ant_los1 + (( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 1 AND a.vk_sit = 'Land/HVS/50/dicht'::text AND a.neigung = 4)) * b.ant_los2 + (( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 1 AND a.vk_sit = 'Land/HVS/50/gesaettigt'::text AND a.neigung = 4)) * b.ant_los3 + (( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 1 AND a.vk_sit = 'Land/HVS/50/stop+go'::text AND a.neigung = 4)) * b.ant_los4) * 365::double precision / 1000::double precision
                    WHEN b.neigung = 6 AND b.vsit::text = 'Land/HVS/50'::text THEN b.dtv2015_snf::double precision * ((( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 1 AND a.vk_sit = 'Land/HVS/50/fluessig'::text AND a.neigung = 6)) * b.ant_los1 + (( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 1 AND a.vk_sit = 'Land/HVS/50/dicht'::text AND a.neigung = 6)) * b.ant_los2 + (( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 1 AND a.vk_sit = 'Land/HVS/50/gesaettigt'::text AND a.neigung = 6)) * b.ant_los3 + (( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 1 AND a.vk_sit = 'Land/HVS/50/stop+go'::text AND a.neigung = 6)) * b.ant_los4) * 365::double precision / 1000::double precision
                    WHEN b.neigung = 0 AND b.vsit::text = 'Land/HVS/60'::text THEN b.dtv2015_snf::double precision * ((( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 1 AND a.vk_sit = 'Land/HVS/60/fluessig'::text AND a.neigung = 0)) * b.ant_los1 + (( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 1 AND a.vk_sit = 'Land/HVS/60/dicht'::text AND a.neigung = 0)) * b.ant_los2 + (( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 1 AND a.vk_sit = 'Land/HVS/60/gesaettigt'::text AND a.neigung = 0)) * b.ant_los3 + (( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 1 AND a.vk_sit = 'Land/HVS/60/stop+go'::text AND a.neigung = 0)) * b.ant_los4) * 365::double precision / 1000::double precision
                    WHEN b.neigung = 2 AND b.vsit::text = 'Land/HVS/60'::text THEN b.dtv2015_snf::double precision * ((( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 1 AND a.vk_sit = 'Land/HVS/60/fluessig'::text AND a.neigung = 2)) * b.ant_los1 + (( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 1 AND a.vk_sit = 'Land/HVS/60/dicht'::text AND a.neigung = 2)) * b.ant_los2 + (( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 1 AND a.vk_sit = 'Land/HVS/60/gesaettigt'::text AND a.neigung = 2)) * b.ant_los3 + (( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 1 AND a.vk_sit = 'Land/HVS/60/stop+go'::text AND a.neigung = 2)) * b.ant_los4) * 365::double precision / 1000::double precision
                    WHEN b.neigung = 4 AND b.vsit::text = 'Land/HVS/60'::text THEN b.dtv2015_snf::double precision * ((( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 1 AND a.vk_sit = 'Land/HVS/60/fluessig'::text AND a.neigung = 4)) * b.ant_los1 + (( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 1 AND a.vk_sit = 'Land/HVS/60/dicht'::text AND a.neigung = 4)) * b.ant_los2 + (( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 1 AND a.vk_sit = 'Land/HVS/60/gesaettigt'::text AND a.neigung = 4)) * b.ant_los3 + (( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 1 AND a.vk_sit = 'Land/HVS/60/stop+go'::text AND a.neigung = 4)) * b.ant_los4) * 365::double precision / 1000::double precision
                    WHEN b.neigung = 6 AND b.vsit::text = 'Land/HVS/60'::text THEN b.dtv2015_snf::double precision * ((( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 1 AND a.vk_sit = 'Land/HVS/60/fluessig'::text AND a.neigung = 6)) * b.ant_los1 + (( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 1 AND a.vk_sit = 'Land/HVS/60/dicht'::text AND a.neigung = 6)) * b.ant_los2 + (( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 1 AND a.vk_sit = 'Land/HVS/60/gesaettigt'::text AND a.neigung = 6)) * b.ant_los3 + (( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 1 AND a.vk_sit = 'Land/HVS/60/stop+go'::text AND a.neigung = 6)) * b.ant_los4) * 365::double precision / 1000::double precision
                    WHEN b.neigung = 0 AND b.vsit::text = 'Land/HVS/70'::text THEN b.dtv2015_snf::double precision * ((( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                    ...
                    WHEN b.neigung = 0 AND b.vsit::text = 'Land/Sammel/50'::text THEN b.dtv2015_snf::double precision * ((( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 1 AND a.vk_sit = 'Land/Sammel/50/fluessig'::text AND a.neigung = 0)) * b.ant_los1 + (( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 1 AND a.vk_sit = 'Land/Sammel/50/dicht'::text AND a.neigung = 0)) * b.ant_los2 + (( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 1 AND a.vk_sit = 'Land/Sammel/50/gesaettigt'::text AND a.neigung = 0)) * b.ant_los3 + (( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 1 AND a.vk_sit = 'Land/Sammel/50/stop+go'::text AND a.neigung = 0)) * b.ant_los4) * 365::double precision / 1000::double precision
                    WHEN b.neigung = 2 AND b.vsit::text = 'Land/Sammel/50'::text THEN b.dtv2015_snf::double precision * ((( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 1 AND a.vk_sit = 'Land/Sammel/50/fluessig'::text AND a.neigung = 2)) * b.ant_los1 + (( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 1 AND a.vk_sit = 'Land/Sammel/50/dicht'::text AND a.neigung = 2)) * b.ant_los2 + (( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 1 AND a.vk_sit = 'Land/Sammel/50/gesaettigt'::text AND a.neigung = 2)) * b.ant_los3 + (( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 1 AND a.vk_sit = 'Land/Sammel/50/stop+go'::text AND a.neigung = 2)) * b.ant_los4) * 365::double precision / 1000::double precision
                    WHEN b.neigung = 4 AND b.vsit::text = 'Land/Sammel/50'::text THEN b.dtv2015_snf::double precision * ((( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 1 AND a.vk_sit = 'Land/Sammel/50/fluessig'::text AND a.neigung = 4)) * b.ant_los1 + (( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 1 AND a.vk_sit = 'Land/Sammel/50/dicht'::text AND a.neigung = 4)) * b.ant_los2 + (( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 1 AND a.vk_sit = 'Land/Sammel/50/gesaettigt'::text AND a.neigung = 4)) * b.ant_los3 + (( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 1 AND a.vk_sit = 'Land/Sammel/50/stop+go'::text AND a.neigung = 4)) * b.ant_los4) * 365::double precision / 1000::double precision
                    WHEN b.neigung = 6 AND b.vsit::text = 'Land/Sammel/50'::text THEN b.dtv2015_snf::double precision * ((( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 1 AND a.vk_sit = 'Land/Sammel/50/fluessig'::text AND a.neigung = 6)) * b.ant_los1 + (( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 1 AND a.vk_sit = 'Land/Sammel/50/dicht'::text AND a.neigung = 6)) * b.ant_los2 + (( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 1 AND a.vk_sit = 'Land/Sammel/50/gesaettigt'::text AND a.neigung = 6)) * b.ant_los3 + (( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 1 AND a.vk_sit = 'Land/Sammel/50/stop+go'::text AND a.neigung = 6)) * b.ant_los4) * 365::double precision / 1000::double precision
                    WHEN b.neigung = 0 AND b.vsit::text = 'Land/Sammel/60'::text THEN b.dtv2015_snf::double precision * ((( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                ...
                CASE
                    ...
                    WHEN b.neigung = 0 AND b.vsit::text = 'Land/Erschliessung/30'::text THEN b.dtv2015_snf::double precision * ((( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 22 AND a.vk_sit = 'Land/Erschliessung/30/fluessig'::text AND a.neigung = 0)) * b.ant_los1 + (( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 22 AND a.vk_sit = 'Land/Erschliessung/30/dicht'::text AND a.neigung = 0)) * b.ant_los2 + (( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 22 AND a.vk_sit = 'Land/Erschliessung/30/gesaettigt'::text AND a.neigung = 0)) * b.ant_los3 + (( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 22 AND a.vk_sit = 'Land/Erschliessung/30/stop+go'::text AND a.neigung = 0)) * b.ant_los4) * 365::double precision / 1000::double precision
                    WHEN b.neigung = 2 AND b.vsit::text = 'Land/Erschliessung/30'::text THEN b.dtv2015_snf::double precision * ((( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 22 AND a.vk_sit = 'Land/Erschliessung/30/fluessig'::text AND a.neigung = 2)) * b.ant_los1 + (( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 22 AND a.vk_sit = 'Land/Erschliessung/30/dicht'::text AND a.neigung = 2)) * b.ant_los2 + (( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 22 AND a.vk_sit = 'Land/Erschliessung/30/gesaettigt'::text AND a.neigung = 2)) * b.ant_los3 + (( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 22 AND a.vk_sit = 'Land/Erschliessung/30/stop+go'::text AND a.neigung = 2)) * b.ant_los4) * 365::double precision / 1000::double precision
                    WHEN b.neigung = 4 AND b.vsit::text = 'Land/Erschliessung/30'::text THEN b.dtv2015_snf::double precision * ((( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 22 AND a.vk_sit = 'Land/Erschliessung/30/fluessig'::text AND a.neigung = 4)) * b.ant_los1 + (( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 22 AND a.vk_sit = 'Land/Erschliessung/30/dicht'::text AND a.neigung = 4)) * b.ant_los2 + (( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 22 AND a.vk_sit = 'Land/Erschliessung/30/gesaettigt'::text AND a.neigung = 4)) * b.ant_los3 + (( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 22 AND a.vk_sit = 'Land/Erschliessung/30/stop+go'::text AND a.neigung = 4)) * b.ant_los4) * 365::double precision / 1000::double precision
                    WHEN b.neigung = 6 AND b.vsit::text = 'Land/Erschliessung/30'::text THEN b.dtv2015_snf::double precision * ((( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 22 AND a.vk_sit = 'Land/Erschliessung/30/fluessig'::text AND a.neigung = 6)) * b.ant_los1 + (( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 22 AND a.vk_sit = 'Land/Erschliessung/30/dicht'::text AND a.neigung = 6)) * b.ant_los2 + (( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 22 AND a.vk_sit = 'Land/Erschliessung/30/gesaettigt'::text AND a.neigung = 6)) * b.ant_los3 + (( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 22 AND a.vk_sit = 'Land/Erschliessung/30/stop+go'::text AND a.neigung = 6)) * b.ant_los4) * 365::double precision / 1000::double precision
                    WHEN b.neigung = 0 AND b.vsit::text = 'Land/Erschliessung/40'::text THEN b.dtv2015_snf::double precision * ((( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 22 AND a.vk_sit = 'Land/Erschliessung/40/fluessig'::text AND a.neigung = 0)) * b.ant_los1 + (( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 22 AND a.vk_sit = 'Land/Erschliessung/40/dicht'::text AND a.neigung = 0)) * b.ant_los2 + (( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 22 AND a.vk_sit = 'Land/Erschliessung/40/gesaettigt'::text AND a.neigung = 0)) * b.ant_los3 + (( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 22 AND a.vk_sit = 'Land/Erschliessung/40/stop+go'::text AND a.neigung = 0)) * b.ant_los4) * 365::double precision / 1000::double precision
                    WHEN b.neigung = 2 AND b.vsit::text = 'Land/Erschliessung/40'::text THEN b.dtv2015_snf::double precision * ((( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 22 AND a.vk_sit = 'Land/Erschliessung/40/fluessig'::text AND a.neigung = 2)) * b.ant_los1 + (( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 22 AND a.vk_sit = 'Land/Erschliessung/40/dicht'::text AND a.neigung = 2)) * b.ant_los2 + (( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 22 AND a.vk_sit = 'Land/Erschliessung/40/gesaettigt'::text AND a.neigung = 2)) * b.ant_los3 + (( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 22 AND a.vk_sit = 'Land/Erschliessung/40/stop+go'::text AND a.neigung = 2)) * b.ant_los4) * 365::double precision / 1000::double precision
                    WHEN b.neigung = 4 AND b.vsit::text = 'Land/Erschliessung/40'::text THEN b.dtv2015_snf::double precision * ((( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 22 AND a.vk_sit = 'Land/Erschliessung/40/fluessig'::text AND a.neigung = 4)) * b.ant_los1 + (( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 22 AND a.vk_sit = 'Land/Erschliessung/40/dicht'::text AND a.neigung = 4)) * b.ant_los2 + (( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 22 AND a.vk_sit = 'Land/Erschliessung/40/gesaettigt'::text AND a.neigung = 4)) * b.ant_los3 + (( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 22 AND a.vk_sit = 'Land/Erschliessung/40/stop+go'::text AND a.neigung = 4)) * b.ant_los4) * 365::double precision / 1000::double precision
                    WHEN b.neigung = 6 AND b.vsit::text = 'Land/Erschliessung/40'::text THEN b.dtv2015_snf::double precision * ((( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 22 AND a.vk_sit = 'Land/Erschliessung/40/fluessig'::text AND a.neigung = 6)) * b.ant_los1 + (( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 22 AND a.vk_sit = 'Land/Erschliessung/40/dicht'::text AND a.neigung = 6)) * b.ant_los2 + (( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 22 AND a.vk_sit = 'Land/Erschliessung/40/gesaettigt'::text AND a.neigung = 6)) * b.ant_los3 + (( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 22 AND a.vk_sit = 'Land/Erschliessung/40/stop+go'::text AND a.neigung = 6)) * b.ant_los4) * 365::double precision / 1000::double precision
                    WHEN b.neigung = 0 AND b.vsit::text = 'Land/Erschliessung/50'::text THEN b.dtv2015_snf::double precision * ((( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                    ...
                    WHEN b.neigung = 0 AND b.vsit::text = 'Land/HVS/30'::text THEN b.dtv2015_snf::double precision * ((( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 22 AND a.vk_sit = 'Land/HVS/30/fluessig'::text AND a.neigung = 0)) * b.ant_los1 + (( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 22 AND a.vk_sit = 'Land/HVS/30/dicht'::text AND a.neigung = 0)) * b.ant_los2 + (( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 22 AND a.vk_sit = 'Land/HVS/30/gesaettigt'::text AND a.neigung = 0)) * b.ant_los3 + (( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 22 AND a.vk_sit = 'Land/HVS/30/stop+go'::text AND a.neigung = 0)) * b.ant_los4) * 365::double precision / 1000::double precision
                    WHEN b.neigung = 2 AND b.vsit::text = 'Land/HVS/30'::text THEN b.dtv2015_snf::double precision * ((( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 22 AND a.vk_sit = 'Land/HVS/30/fluessig'::text AND a.neigung = 2)) * b.ant_los1 + (( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 22 AND a.vk_sit = 'Land/HVS/30/dicht'::text AND a.neigung = 2)) * b.ant_los2 + (( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 22 AND a.vk_sit = 'Land/HVS/30/gesaettigt'::text AND a.neigung = 2)) * b.ant_los3 + (( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 22 AND a.vk_sit = 'Land/HVS/30/stop+go'::text AND a.neigung = 2)) * b.ant_los4) * 365::double precision / 1000::double precision
                    WHEN b.neigung = 4 AND b.vsit::text = 'Land/HVS/30'::text THEN b.dtv2015_snf::double precision * ((( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 22 AND a.vk_sit = 'Land/HVS/30/fluessig'::text AND a.neigung = 4)) * b.ant_los1 + (( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 22 AND a.vk_sit = 'Land/HVS/30/dicht'::text AND a.neigung = 4)) * b.ant_los2 + (( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 22 AND a.vk_sit = 'Land/HVS/30/gesaettigt'::text AND a.neigung = 4)) * b.ant_los3 + (( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 22 AND a.vk_sit = 'Land/HVS/30/stop+go'::text AND a.neigung = 4)) * b.ant_los4) * 365::double precision / 1000::double precision
                    WHEN b.neigung = 6 AND b.vsit::text = 'Land/HVS/30'::text THEN b.dtv2015_snf::double precision * ((( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 22 AND a.vk_sit = 'Land/HVS/30/fluessig'::text AND a.neigung = 6)) * b.ant_los1 + (( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 22 AND a.vk_sit = 'Land/HVS/30/dicht'::text AND a.neigung = 6)) * b.ant_los2 + (( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 22 AND a.vk_sit = 'Land/HVS/30/gesaettigt'::text AND a.neigung = 6)) * b.ant_los3 + (( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 22 AND a.vk_sit = 'Land/HVS/30/stop+go'::text AND a.neigung = 6)) * b.ant_los4) * 365::double precision / 1000::double precision
                    WHEN b.neigung = 0 AND b.vsit::text = 'Land/HVS/40'::text THEN b.dtv2015_snf::double precision * ((( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 22 AND a.vk_sit = 'Land/HVS/40/fluessig'::text AND a.neigung = 0)) * b.ant_los1 + (( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 22 AND a.vk_sit = 'Land/HVS/40/dicht'::text AND a.neigung = 0)) * b.ant_los2 + (( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 22 AND a.vk_sit = 'Land/HVS/40/gesaettigt'::text AND a.neigung = 0)) * b.ant_los3 + (( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 22 AND a.vk_sit = 'Land/HVS/40/stop+go'::text AND a.neigung = 0)) * b.ant_los4) * 365::double precision / 1000::double precision
                    WHEN b.neigung = 2 AND b.vsit::text = 'Land/HVS/40'::text THEN b.dtv2015_snf::double precision * ((( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 22 AND a.vk_sit = 'Land/HVS/40/fluessig'::text AND a.neigung = 2)) * b.ant_los1 + (( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 22 AND a.vk_sit = 'Land/HVS/40/dicht'::text AND a.neigung = 2)) * b.ant_los2 + (( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 22 AND a.vk_sit = 'Land/HVS/40/gesaettigt'::text AND a.neigung = 2)) * b.ant_los3 + (( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 22 AND a.vk_sit = 'Land/HVS/40/stop+go'::text AND a.neigung = 2)) * b.ant_los4) * 365::double precision / 1000::double precision
                    WHEN b.neigung = 4 AND b.vsit::text = 'Land/HVS/40'::text THEN b.dtv2015_snf::double precision * ((( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 22 AND a.vk_sit = 'Land/HVS/40/fluessig'::text AND a.neigung = 4)) * b.ant_los1 + (( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 22 AND a.vk_sit = 'Land/HVS/40/dicht'::text AND a.neigung = 4)) * b.ant_los2 + (( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 22 AND a.vk_sit = 'Land/HVS/40/gesaettigt'::text AND a.neigung = 4)) * b.ant_los3 + (( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 22 AND a.vk_sit = 'Land/HVS/40/stop+go'::text AND a.neigung = 4)) * b.ant_los4) * 365::double precision / 1000::double precision
                    WHEN b.neigung = 6 AND b.vsit::text = 'Land/HVS/40'::text THEN b.dtv2015_snf::double precision * ((( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 22 AND a.vk_sit = 'Land/HVS/40/fluessig'::text AND a.neigung = 6)) * b.ant_los1 + (( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 22 AND a.vk_sit = 'Land/HVS/40/dicht'::text AND a.neigung = 6)) * b.ant_los2 + (( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 22 AND a.vk_sit = 'Land/HVS/40/gesaettigt'::text AND a.neigung = 6)) * b.ant_los3 + (( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 22 AND a.vk_sit = 'Land/HVS/40/stop+go'::text AND a.neigung = 6)) * b.ant_los4) * 365::double precision / 1000::double precision
                    WHEN b.neigung = 0 AND b.vsit::text = 'Land/HVS/50'::text THEN b.dtv2015_snf::double precision * ((( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 22 AND a.vk_sit = 'Land/HVS/50/fluessig'::text AND a.neigung = 0)) * b.ant_los1 + (( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 22 AND a.vk_sit = 'Land/HVS/50/dicht'::text AND a.neigung = 0)) * b.ant_los2 + (( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 22 AND a.vk_sit = 'Land/HVS/50/gesaettigt'::text AND a.neigung = 0)) * b.ant_los3 + (( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 22 AND a.vk_sit = 'Land/HVS/50/stop+go'::text AND a.neigung = 0)) * b.ant_los4) * 365::double precision / 1000::double precision
                    WHEN b.neigung = 2 AND b.vsit::text = 'Land/HVS/50'::text THEN b.dtv2015_snf::double precision * ((( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 22 AND a.vk_sit = 'Land/HVS/50/fluessig'::text AND a.neigung = 2)) * b.ant_los1 + (( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 22 AND a.vk_sit = 'Land/HVS/50/dicht'::text AND a.neigung = 2)) * b.ant_los2 + (( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 22 AND a.vk_sit = 'Land/HVS/50/gesaettigt'::text AND a.neigung = 2)) * b.ant_los3 + (( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 22 AND a.vk_sit = 'Land/HVS/50/stop+go'::text AND a.neigung = 2)) * b.ant_los4) * 365::double precision / 1000::double precision
                    WHEN b.neigung = 4 AND b.vsit::text = 'Land/HVS/50'::text THEN b.dtv2015_snf::double precision * ((( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 22 AND a.vk_sit = 'Land/HVS/50/fluessig'::text AND a.neigung = 4)) * b.ant_los1 + (( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 22 AND a.vk_sit = 'Land/HVS/50/dicht'::text AND a.neigung = 4)) * b.ant_los2 + (( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 22 AND a.vk_sit = 'Land/HVS/50/gesaettigt'::text AND a.neigung = 4)) * b.ant_los3 + (( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 22 AND a.vk_sit = 'Land/HVS/50/stop+go'::text AND a.neigung = 4)) * b.ant_los4) * 365::double precision / 1000::double precision
                    WHEN b.neigung = 6 AND b.vsit::text = 'Land/HVS/50'::text THEN b.dtv2015_snf::double precision * ((( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 22 AND a.vk_sit = 'Land/HVS/50/fluessig'::text AND a.neigung = 6)) * b.ant_los1 + (( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 22 AND a.vk_sit = 'Land/HVS/50/dicht'::text AND a.neigung = 6)) * b.ant_los2 + (( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 22 AND a.vk_sit = 'Land/HVS/50/gesaettigt'::text AND a.neigung = 6)) * b.ant_los3 + (( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 22 AND a.vk_sit = 'Land/HVS/50/stop+go'::text AND a.neigung = 6)) * b.ant_los4) * 365::double precision / 1000::double precision
                    WHEN b.neigung = 0 AND b.vsit::text = 'Land/HVS/60'::text THEN b.dtv2015_snf::double precision * ((( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 22 AND a.vk_sit = 'Land/HVS/60/fluessig'::text AND a.neigung = 0)) * b.ant_los1 + (( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 22 AND a.vk_sit = 'Land/HVS/60/dicht'::text AND a.neigung = 0)) * b.ant_los2 + (( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 22 AND a.vk_sit = 'Land/HVS/60/gesaettigt'::text AND a.neigung = 0)) * b.ant_los3 + (( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 22 AND a.vk_sit = 'Land/HVS/60/stop+go'::text AND a.neigung = 0)) * b.ant_los4) * 365::double precision / 1000::double precision
                    WHEN b.neigung = 2 AND b.vsit::text = 'Land/HVS/60'::text THEN b.dtv2015_snf::double precision * ((( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 22 AND a.vk_sit = 'Land/HVS/60/fluessig'::text AND a.neigung = 2)) * b.ant_los1 + (( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 22 AND a.vk_sit = 'Land/HVS/60/dicht'::text AND a.neigung = 2)) * b.ant_los2 + (( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 22 AND a.vk_sit = 'Land/HVS/60/gesaettigt'::text AND a.neigung = 2)) * b.ant_los3 + (( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 22 AND a.vk_sit = 'Land/HVS/60/stop+go'::text AND a.neigung = 2)) * b.ant_los4) * 365::double precision / 1000::double precision
                    WHEN b.neigung = 4 AND b.vsit::text = 'Land/HVS/60'::text THEN b.dtv2015_snf::double precision * ((( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 22 AND a.vk_sit = 'Land/HVS/60/fluessig'::text AND a.neigung = 4)) * b.ant_los1 + (( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 22 AND a.vk_sit = 'Land/HVS/60/dicht'::text AND a.neigung = 4)) * b.ant_los2 + (( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 22 AND a.vk_sit = 'Land/HVS/60/gesaettigt'::text AND a.neigung = 4)) * b.ant_los3 + (( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 22 AND a.vk_sit = 'Land/HVS/60/stop+go'::text AND a.neigung = 4)) * b.ant_los4) * 365::double precision / 1000::double precision
                    WHEN b.neigung = 6 AND b.vsit::text = 'Land/HVS/60'::text THEN b.dtv2015_snf::double precision * ((( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 22 AND a.vk_sit = 'Land/HVS/60/fluessig'::text AND a.neigung = 6)) * b.ant_los1 + (( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 22 AND a.vk_sit = 'Land/HVS/60/dicht'::text AND a.neigung = 6)) * b.ant_los2 + (( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 22 AND a.vk_sit = 'Land/HVS/60/gesaettigt'::text AND a.neigung = 6)) * b.ant_los3 + (( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 22 AND a.vk_sit = 'Land/HVS/60/stop+go'::text AND a.neigung = 6)) * b.ant_los4) * 365::double precision / 1000::double precision
                    WHEN b.neigung = 0 AND b.vsit::text = 'Land/HVS/70'::text THEN b.dtv2015_snf::double precision * ((( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                    ...
                    WHEN b.neigung = 0 AND b.vsit::text = 'Land/Sammel/50'::text THEN b.dtv2015_snf::double precision * ((( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 22 AND a.vk_sit = 'Land/Sammel/50/fluessig'::text AND a.neigung = 0)) * b.ant_los1 + (( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 22 AND a.vk_sit = 'Land/Sammel/50/dicht'::text AND a.neigung = 0)) * b.ant_los2 + (( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 22 AND a.vk_sit = 'Land/Sammel/50/gesaettigt'::text AND a.neigung = 0)) * b.ant_los3 + (( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 22 AND a.vk_sit = 'Land/Sammel/50/stop+go'::text AND a.neigung = 0)) * b.ant_los4) * 365::double precision / 1000::double precision
                    WHEN b.neigung = 2 AND b.vsit::text = 'Land/Sammel/50'::text THEN b.dtv2015_snf::double precision * ((( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 22 AND a.vk_sit = 'Land/Sammel/50/fluessig'::text AND a.neigung = 2)) * b.ant_los1 + (( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 22 AND a.vk_sit = 'Land/Sammel/50/dicht'::text AND a.neigung = 2)) * b.ant_los2 + (( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 22 AND a.vk_sit = 'Land/Sammel/50/gesaettigt'::text AND a.neigung = 2)) * b.ant_los3 + (( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 22 AND a.vk_sit = 'Land/Sammel/50/stop+go'::text AND a.neigung = 2)) * b.ant_los4) * 365::double precision / 1000::double precision
                    WHEN b.neigung = 4 AND b.vsit::text = 'Land/Sammel/50'::text THEN b.dtv2015_snf::double precision * ((( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 22 AND a.vk_sit = 'Land/Sammel/50/fluessig'::text AND a.neigung = 4)) * b.ant_los1 + (( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 22 AND a.vk_sit = 'Land/Sammel/50/dicht'::text AND a.neigung = 4)) * b.ant_los2 + (( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 22 AND a.vk_sit = 'Land/Sammel/50/gesaettigt'::text AND a.neigung = 4)) * b.ant_los3 + (( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 22 AND a.vk_sit = 'Land/Sammel/50/stop+go'::text AND a.neigung = 4)) * b.ant_los4) * 365::double precision / 1000::double precision
                    WHEN b.neigung = 6 AND b.vsit::text = 'Land/Sammel/50'::text THEN b.dtv2015_snf::double precision * ((( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 22 AND a.vk_sit = 'Land/Sammel/50/fluessig'::text AND a.neigung = 6)) * b.ant_los1 + (( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 22 AND a.vk_sit = 'Land/Sammel/50/dicht'::text AND a.neigung = 6)) * b.ant_los2 + (( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 22 AND a.vk_sit = 'Land/Sammel/50/gesaettigt'::text AND a.neigung = 6)) * b.ant_los3 + (( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 22 AND a.vk_sit = 'Land/Sammel/50/stop+go'::text AND a.neigung = 6)) * b.ant_los4) * 365::double precision / 1000::double precision
                    WHEN b.neigung = 0 AND b.vsit::text = 'Land/Sammel/60'::text THEN b.dtv2015_snf::double precision * ((( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                ...
                CASE
                    ...
                    WHEN b.neigung = 0 AND b.vsit::text = 'Land/Erschliessung/30'::text THEN b.dtv2015_snf::double precision * ((( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 6 AND a.vk_sit = 'Land/Erschliessung/30/fluessig'::text AND a.neigung = 0)) * b.ant_los1 + (( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 6 AND a.vk_sit = 'Land/Erschliessung/30/dicht'::text AND a.neigung = 0)) * b.ant_los2 + (( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 6 AND a.vk_sit = 'Land/Erschliessung/30/gesaettigt'::text AND a.neigung = 0)) * b.ant_los3 + (( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 6 AND a.vk_sit = 'Land/Erschliessung/30/stop+go'::text AND a.neigung = 0)) * b.ant_los4) * 365::double precision / 1000::double precision
                    WHEN b.neigung = 2 AND b.vsit::text = 'Land/Erschliessung/30'::text THEN b.dtv2015_snf::double precision * ((( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 6 AND a.vk_sit = 'Land/Erschliessung/30/fluessig'::text AND a.neigung = 2)) * b.ant_los1 + (( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 6 AND a.vk_sit = 'Land/Erschliessung/30/dicht'::text AND a.neigung = 2)) * b.ant_los2 + (( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 6 AND a.vk_sit = 'Land/Erschliessung/30/gesaettigt'::text AND a.neigung = 2)) * b.ant_los3 + (( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 6 AND a.vk_sit = 'Land/Erschliessung/30/stop+go'::text AND a.neigung = 2)) * b.ant_los4) * 365::double precision / 1000::double precision
                    WHEN b.neigung = 4 AND b.vsit::text = 'Land/Erschliessung/30'::text THEN b.dtv2015_snf::double precision * ((( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 6 AND a.vk_sit = 'Land/Erschliessung/30/fluessig'::text AND a.neigung = 4)) * b.ant_los1 + (( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 6 AND a.vk_sit = 'Land/Erschliessung/30/dicht'::text AND a.neigung = 4)) * b.ant_los2 + (( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 6 AND a.vk_sit = 'Land/Erschliessung/30/gesaettigt'::text AND a.neigung = 4)) * b.ant_los3 + (( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 6 AND a.vk_sit = 'Land/Erschliessung/30/stop+go'::text AND a.neigung = 4)) * b.ant_los4) * 365::double precision / 1000::double precision
                    WHEN b.neigung = 6 AND b.vsit::text = 'Land/Erschliessung/30'::text THEN b.dtv2015_snf::double precision * ((( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 6 AND a.vk_sit = 'Land/Erschliessung/30/fluessig'::text AND a.neigung = 6)) * b.ant_los1 + (( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 6 AND a.vk_sit = 'Land/Erschliessung/30/dicht'::text AND a.neigung = 6)) * b.ant_los2 + (( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 6 AND a.vk_sit = 'Land/Erschliessung/30/gesaettigt'::text AND a.neigung = 6)) * b.ant_los3 + (( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 6 AND a.vk_sit = 'Land/Erschliessung/30/stop+go'::text AND a.neigung = 6)) * b.ant_los4) * 365::double precision / 1000::double precision
                    WHEN b.neigung = 0 AND b.vsit::text = 'Land/Erschliessung/40'::text THEN b.dtv2015_snf::double precision * ((( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 6 AND a.vk_sit = 'Land/Erschliessung/40/fluessig'::text AND a.neigung = 0)) * b.ant_los1 + (( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 6 AND a.vk_sit = 'Land/Erschliessung/40/dicht'::text AND a.neigung = 0)) * b.ant_los2 + (( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 6 AND a.vk_sit = 'Land/Erschliessung/40/gesaettigt'::text AND a.neigung = 0)) * b.ant_los3 + (( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 6 AND a.vk_sit = 'Land/Erschliessung/40/stop+go'::text AND a.neigung = 0)) * b.ant_los4) * 365::double precision / 1000::double precision
                    WHEN b.neigung = 2 AND b.vsit::text = 'Land/Erschliessung/40'::text THEN b.dtv2015_snf::double precision * ((( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 6 AND a.vk_sit = 'Land/Erschliessung/40/fluessig'::text AND a.neigung = 2)) * b.ant_los1 + (( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 6 AND a.vk_sit = 'Land/Erschliessung/40/dicht'::text AND a.neigung = 2)) * b.ant_los2 + (( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 6 AND a.vk_sit = 'Land/Erschliessung/40/gesaettigt'::text AND a.neigung = 2)) * b.ant_los3 + (( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 6 AND a.vk_sit = 'Land/Erschliessung/40/stop+go'::text AND a.neigung = 2)) * b.ant_los4) * 365::double precision / 1000::double precision
                    WHEN b.neigung = 4 AND b.vsit::text = 'Land/Erschliessung/40'::text THEN b.dtv2015_snf::double precision * ((( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 6 AND a.vk_sit = 'Land/Erschliessung/40/fluessig'::text AND a.neigung = 4)) * b.ant_los1 + (( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 6 AND a.vk_sit = 'Land/Erschliessung/40/dicht'::text AND a.neigung = 4)) * b.ant_los2 + (( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 6 AND a.vk_sit = 'Land/Erschliessung/40/gesaettigt'::text AND a.neigung = 4)) * b.ant_los3 + (( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 6 AND a.vk_sit = 'Land/Erschliessung/40/stop+go'::text AND a.neigung = 4)) * b.ant_los4) * 365::double precision / 1000::double precision
                    WHEN b.neigung = 6 AND b.vsit::text = 'Land/Erschliessung/40'::text THEN b.dtv2015_snf::double precision * ((( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 6 AND a.vk_sit = 'Land/Erschliessung/40/fluessig'::text AND a.neigung = 6)) * b.ant_los1 + (( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 6 AND a.vk_sit = 'Land/Erschliessung/40/dicht'::text AND a.neigung = 6)) * b.ant_los2 + (( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 6 AND a.vk_sit = 'Land/Erschliessung/40/gesaettigt'::text AND a.neigung = 6)) * b.ant_los3 + (( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 6 AND a.vk_sit = 'Land/Erschliessung/40/stop+go'::text AND a.neigung = 6)) * b.ant_los4) * 365::double precision / 1000::double precision
                    WHEN b.neigung = 0 AND b.vsit::text = 'Land/Erschliessung/50'::text THEN b.dtv2015_snf::double precision * ((( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                    ...
                    WHEN b.neigung = 0 AND b.vsit::text = 'Land/HVS/30'::text THEN b.dtv2015_snf::double precision * ((( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 6 AND a.vk_sit = 'Land/HVS/30/fluessig'::text AND a.neigung = 0)) * b.ant_los1 + (( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 6 AND a.vk_sit = 'Land/HVS/30/dicht'::text AND a.neigung = 0)) * b.ant_los2 + (( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 6 AND a.vk_sit = 'Land/HVS/30/gesaettigt'::text AND a.neigung = 0)) * b.ant_los3 + (( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 6 AND a.vk_sit = 'Land/HVS/30/stop+go'::text AND a.neigung = 0)) * b.ant_los4) * 365::double precision / 1000::double precision
                    WHEN b.neigung = 2 AND b.vsit::text = 'Land/HVS/30'::text THEN b.dtv2015_snf::double precision * ((( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 6 AND a.vk_sit = 'Land/HVS/30/fluessig'::text AND a.neigung = 2)) * b.ant_los1 + (( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 6 AND a.vk_sit = 'Land/HVS/30/dicht'::text AND a.neigung = 2)) * b.ant_los2 + (( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 6 AND a.vk_sit = 'Land/HVS/30/gesaettigt'::text AND a.neigung = 2)) * b.ant_los3 + (( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 6 AND a.vk_sit = 'Land/HVS/30/stop+go'::text AND a.neigung = 2)) * b.ant_los4) * 365::double precision / 1000::double precision
                    WHEN b.neigung = 4 AND b.vsit::text = 'Land/HVS/30'::text THEN b.dtv2015_snf::double precision * ((( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 6 AND a.vk_sit = 'Land/HVS/30/fluessig'::text AND a.neigung = 4)) * b.ant_los1 + (( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 6 AND a.vk_sit = 'Land/HVS/30/dicht'::text AND a.neigung = 4)) * b.ant_los2 + (( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 6 AND a.vk_sit = 'Land/HVS/30/gesaettigt'::text AND a.neigung = 4)) * b.ant_los3 + (( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 6 AND a.vk_sit = 'Land/HVS/30/stop+go'::text AND a.neigung = 4)) * b.ant_los4) * 365::double precision / 1000::double precision
                    WHEN b.neigung = 6 AND b.vsit::text = 'Land/HVS/30'::text THEN b.dtv2015_snf::double precision * ((( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 6 AND a.vk_sit = 'Land/HVS/30/fluessig'::text AND a.neigung = 6)) * b.ant_los1 + (( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 6 AND a.vk_sit = 'Land/HVS/30/dicht'::text AND a.neigung = 6)) * b.ant_los2 + (( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 6 AND a.vk_sit = 'Land/HVS/30/gesaettigt'::text AND a.neigung = 6)) * b.ant_los3 + (( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 6 AND a.vk_sit = 'Land/HVS/30/stop+go'::text AND a.neigung = 6)) * b.ant_los4) * 365::double precision / 1000::double precision
                    WHEN b.neigung = 0 AND b.vsit::text = 'Land/HVS/40'::text THEN b.dtv2015_snf::double precision * ((( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 6 AND a.vk_sit = 'Land/HVS/40/fluessig'::text AND a.neigung = 0)) * b.ant_los1 + (( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 6 AND a.vk_sit = 'Land/HVS/40/dicht'::text AND a.neigung = 0)) * b.ant_los2 + (( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 6 AND a.vk_sit = 'Land/HVS/40/gesaettigt'::text AND a.neigung = 0)) * b.ant_los3 + (( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 6 AND a.vk_sit = 'Land/HVS/40/stop+go'::text AND a.neigung = 0)) * b.ant_los4) * 365::double precision / 1000::double precision
                    WHEN b.neigung = 2 AND b.vsit::text = 'Land/HVS/40'::text THEN b.dtv2015_snf::double precision * ((( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 6 AND a.vk_sit = 'Land/HVS/40/fluessig'::text AND a.neigung = 2)) * b.ant_los1 + (( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 6 AND a.vk_sit = 'Land/HVS/40/dicht'::text AND a.neigung = 2)) * b.ant_los2 + (( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 6 AND a.vk_sit = 'Land/HVS/40/gesaettigt'::text AND a.neigung = 2)) * b.ant_los3 + (( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 6 AND a.vk_sit = 'Land/HVS/40/stop+go'::text AND a.neigung = 2)) * b.ant_los4) * 365::double precision / 1000::double precision
                    WHEN b.neigung = 4 AND b.vsit::text = 'Land/HVS/40'::text THEN b.dtv2015_snf::double precision * ((( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 6 AND a.vk_sit = 'Land/HVS/40/fluessig'::text AND a.neigung = 4)) * b.ant_los1 + (( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 6 AND a.vk_sit = 'Land/HVS/40/dicht'::text AND a.neigung = 4)) * b.ant_los2 + (( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 6 AND a.vk_sit = 'Land/HVS/40/gesaettigt'::text AND a.neigung = 4)) * b.ant_los3 + (( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 6 AND a.vk_sit = 'Land/HVS/40/stop+go'::text AND a.neigung = 4)) * b.ant_los4) * 365::double precision / 1000::double precision
                    WHEN b.neigung = 6 AND b.vsit::text = 'Land/HVS/40'::text THEN b.dtv2015_snf::double precision * ((( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 6 AND a.vk_sit = 'Land/HVS/40/fluessig'::text AND a.neigung = 6)) * b.ant_los1 + (( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 6 AND a.vk_sit = 'Land/HVS/40/dicht'::text AND a.neigung = 6)) * b.ant_los2 + (( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 6 AND a.vk_sit = 'Land/HVS/40/gesaettigt'::text AND a.neigung = 6)) * b.ant_los3 + (( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 6 AND a.vk_sit = 'Land/HVS/40/stop+go'::text AND a.neigung = 6)) * b.ant_los4) * 365::double precision / 1000::double precision
                    WHEN b.neigung = 0 AND b.vsit::text = 'Land/HVS/50'::text THEN b.dtv2015_snf::double precision * ((( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 6 AND a.vk_sit = 'Land/HVS/50/fluessig'::text AND a.neigung = 0)) * b.ant_los1 + (( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 6 AND a.vk_sit = 'Land/HVS/50/dicht'::text AND a.neigung = 0)) * b.ant_los2 + (( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 6 AND a.vk_sit = 'Land/HVS/50/gesaettigt'::text AND a.neigung = 0)) * b.ant_los3 + (( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 6 AND a.vk_sit = 'Land/HVS/50/stop+go'::text AND a.neigung = 0)) * b.ant_los4) * 365::double precision / 1000::double precision
                    WHEN b.neigung = 2 AND b.vsit::text = 'Land/HVS/50'::text THEN b.dtv2015_snf::double precision * ((( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 6 AND a.vk_sit = 'Land/HVS/50/fluessig'::text AND a.neigung = 2)) * b.ant_los1 + (( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 6 AND a.vk_sit = 'Land/HVS/50/dicht'::text AND a.neigung = 2)) * b.ant_los2 + (( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 6 AND a.vk_sit = 'Land/HVS/50/gesaettigt'::text AND a.neigung = 2)) * b.ant_los3 + (( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 6 AND a.vk_sit = 'Land/HVS/50/stop+go'::text AND a.neigung = 2)) * b.ant_los4) * 365::double precision / 1000::double precision
                    WHEN b.neigung = 4 AND b.vsit::text = 'Land/HVS/50'::text THEN b.dtv2015_snf::double precision * ((( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 6 AND a.vk_sit = 'Land/HVS/50/fluessig'::text AND a.neigung = 4)) * b.ant_los1 + (( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 6 AND a.vk_sit = 'Land/HVS/50/dicht'::text AND a.neigung = 4)) * b.ant_los2 + (( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 6 AND a.vk_sit = 'Land/HVS/50/gesaettigt'::text AND a.neigung = 4)) * b.ant_los3 + (( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 6 AND a.vk_sit = 'Land/HVS/50/stop+go'::text AND a.neigung = 4)) * b.ant_los4) * 365::double precision / 1000::double precision
                    WHEN b.neigung = 6 AND b.vsit::text = 'Land/HVS/50'::text THEN b.dtv2015_snf::double precision * ((( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 6 AND a.vk_sit = 'Land/HVS/50/fluessig'::text AND a.neigung = 6)) * b.ant_los1 + (( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 6 AND a.vk_sit = 'Land/HVS/50/dicht'::text AND a.neigung = 6)) * b.ant_los2 + (( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 6 AND a.vk_sit = 'Land/HVS/50/gesaettigt'::text AND a.neigung = 6)) * b.ant_los3 + (( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 6 AND a.vk_sit = 'Land/HVS/50/stop+go'::text AND a.neigung = 6)) * b.ant_los4) * 365::double precision / 1000::double precision
                    WHEN b.neigung = 0 AND b.vsit::text = 'Land/HVS/60'::text THEN b.dtv2015_snf::double precision * ((( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 6 AND a.vk_sit = 'Land/HVS/60/fluessig'::text AND a.neigung = 0)) * b.ant_los1 + (( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 6 AND a.vk_sit = 'Land/HVS/60/dicht'::text AND a.neigung = 0)) * b.ant_los2 + (( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 6 AND a.vk_sit = 'Land/HVS/60/gesaettigt'::text AND a.neigung = 0)) * b.ant_los3 + (( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 6 AND a.vk_sit = 'Land/HVS/60/stop+go'::text AND a.neigung = 0)) * b.ant_los4) * 365::double precision / 1000::double precision
                    WHEN b.neigung = 2 AND b.vsit::text = 'Land/HVS/60'::text THEN b.dtv2015_snf::double precision * ((( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 6 AND a.vk_sit = 'Land/HVS/60/fluessig'::text AND a.neigung = 2)) * b.ant_los1 + (( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 6 AND a.vk_sit = 'Land/HVS/60/dicht'::text AND a.neigung = 2)) * b.ant_los2 + (( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 6 AND a.vk_sit = 'Land/HVS/60/gesaettigt'::text AND a.neigung = 2)) * b.ant_los3 + (( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 6 AND a.vk_sit = 'Land/HVS/60/stop+go'::text AND a.neigung = 2)) * b.ant_los4) * 365::double precision / 1000::double precision
                    WHEN b.neigung = 4 AND b.vsit::text = 'Land/HVS/60'::text THEN b.dtv2015_snf::double precision * ((( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 6 AND a.vk_sit = 'Land/HVS/60/fluessig'::text AND a.neigung = 4)) * b.ant_los1 + (( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 6 AND a.vk_sit = 'Land/HVS/60/dicht'::text AND a.neigung = 4)) * b.ant_los2 + (( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 6 AND a.vk_sit = 'Land/HVS/60/gesaettigt'::text AND a.neigung = 4)) * b.ant_los3 + (( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 6 AND a.vk_sit = 'Land/HVS/60/stop+go'::text AND a.neigung = 4)) * b.ant_los4) * 365::double precision / 1000::double precision
                    WHEN b.neigung = 6 AND b.vsit::text = 'Land/HVS/60'::text THEN b.dtv2015_snf::double precision * ((( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 6 AND a.vk_sit = 'Land/HVS/60/fluessig'::text AND a.neigung = 6)) * b.ant_los1 + (( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 6 AND a.vk_sit = 'Land/HVS/60/dicht'::text AND a.neigung = 6)) * b.ant_los2 + (( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 6 AND a.vk_sit = 'Land/HVS/60/gesaettigt'::text AND a.neigung = 6)) * b.ant_los3 + (( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 6 AND a.vk_sit = 'Land/HVS/60/stop+go'::text AND a.neigung = 6)) * b.ant_los4) * 365::double precision / 1000::double precision
                    WHEN b.neigung = 0 AND b.vsit::text = 'Land/HVS/70'::text THEN b.dtv2015_snf::double precision * ((( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                    ...
                    WHEN b.neigung = 0 AND b.vsit::text = 'Land/Sammel/50'::text THEN b.dtv2015_snf::double precision * ((( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 6 AND a.vk_sit = 'Land/Sammel/50/fluessig'::text AND a.neigung = 0)) * b.ant_los1 + (( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 6 AND a.vk_sit = 'Land/Sammel/50/dicht'::text AND a.neigung = 0)) * b.ant_los2 + (( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 6 AND a.vk_sit = 'Land/Sammel/50/gesaettigt'::text AND a.neigung = 0)) * b.ant_los3 + (( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 6 AND a.vk_sit = 'Land/Sammel/50/stop+go'::text AND a.neigung = 0)) * b.ant_los4) * 365::double precision / 1000::double precision
                    WHEN b.neigung = 2 AND b.vsit::text = 'Land/Sammel/50'::text THEN b.dtv2015_snf::double precision * ((( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 6 AND a.vk_sit = 'Land/Sammel/50/fluessig'::text AND a.neigung = 2)) * b.ant_los1 + (( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 6 AND a.vk_sit = 'Land/Sammel/50/dicht'::text AND a.neigung = 2)) * b.ant_los2 + (( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 6 AND a.vk_sit = 'Land/Sammel/50/gesaettigt'::text AND a.neigung = 2)) * b.ant_los3 + (( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 6 AND a.vk_sit = 'Land/Sammel/50/stop+go'::text AND a.neigung = 2)) * b.ant_los4) * 365::double precision / 1000::double precision
                    WHEN b.neigung = 4 AND b.vsit::text = 'Land/Sammel/50'::text THEN b.dtv2015_snf::double precision * ((( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 6 AND a.vk_sit = 'Land/Sammel/50/fluessig'::text AND a.neigung = 4)) * b.ant_los1 + (( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 6 AND a.vk_sit = 'Land/Sammel/50/dicht'::text AND a.neigung = 4)) * b.ant_los2 + (( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 6 AND a.vk_sit = 'Land/Sammel/50/gesaettigt'::text AND a.neigung = 4)) * b.ant_los3 + (( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 6 AND a.vk_sit = 'Land/Sammel/50/stop+go'::text AND a.neigung = 4)) * b.ant_los4) * 365::double precision / 1000::double precision
                    WHEN b.neigung = 6 AND b.vsit::text = 'Land/Sammel/50'::text THEN b.dtv2015_snf::double precision * ((( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 6 AND a.vk_sit = 'Land/Sammel/50/fluessig'::text AND a.neigung = 6)) * b.ant_los1 + (( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 6 AND a.vk_sit = 'Land/Sammel/50/dicht'::text AND a.neigung = 6)) * b.ant_los2 + (( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 6 AND a.vk_sit = 'Land/Sammel/50/gesaettigt'::text AND a.neigung = 6)) * b.ant_los3 + (( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 6 AND a.vk_sit = 'Land/Sammel/50/stop+go'::text AND a.neigung = 6)) * b.ant_los4) * 365::double precision / 1000::double precision
                    WHEN b.neigung = 0 AND b.vsit::text = 'Land/Sammel/60'::text THEN b.dtv2015_snf::double precision * ((( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                ...
                CASE
                    ...
                    WHEN b.neigung = 0 AND b.vsit::text = 'Land/Erschliessung/30'::text THEN b.dtv2015_snf::double precision * ((( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 8 AND a.vk_sit = 'Land/Erschliessung/30/fluessig'::text AND a.neigung = 0)) * b.ant_los1 + (( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 8 AND a.vk_sit = 'Land/Erschliessung/30/dicht'::text AND a.neigung = 0)) * b.ant_los2 + (( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 8 AND a.vk_sit = 'Land/Erschliessung/30/gesaettigt'::text AND a.neigung = 0)) * b.ant_los3 + (( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 8 AND a.vk_sit = 'Land/Erschliessung/30/stop+go'::text AND a.neigung = 0)) * b.ant_los4) * 365::double precision / 1000::double precision
                    WHEN b.neigung = 2 AND b.vsit::text = 'Land/Erschliessung/30'::text THEN b.dtv2015_snf::double precision * ((( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 8 AND a.vk_sit = 'Land/Erschliessung/30/fluessig'::text AND a.neigung = 2)) * b.ant_los1 + (( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 8 AND a.vk_sit = 'Land/Erschliessung/30/dicht'::text AND a.neigung = 2)) * b.ant_los2 + (( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 8 AND a.vk_sit = 'Land/Erschliessung/30/gesaettigt'::text AND a.neigung = 2)) * b.ant_los3 + (( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 8 AND a.vk_sit = 'Land/Erschliessung/30/stop+go'::text AND a.neigung = 2)) * b.ant_los4) * 365::double precision / 1000::double precision
                    WHEN b.neigung = 4 AND b.vsit::text = 'Land/Erschliessung/30'::text THEN b.dtv2015_snf::double precision * ((( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 8 AND a.vk_sit = 'Land/Erschliessung/30/fluessig'::text AND a.neigung = 4)) * b.ant_los1 + (( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 8 AND a.vk_sit = 'Land/Erschliessung/30/dicht'::text AND a.neigung = 4)) * b.ant_los2 + (( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 8 AND a.vk_sit = 'Land/Erschliessung/30/gesaettigt'::text AND a.neigung = 4)) * b.ant_los3 + (( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 8 AND a.vk_sit = 'Land/Erschliessung/30/stop+go'::text AND a.neigung = 4)) * b.ant_los4) * 365::double precision / 1000::double precision
                    WHEN b.neigung = 6 AND b.vsit::text = 'Land/Erschliessung/30'::text THEN b.dtv2015_snf::double precision * ((( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 8 AND a.vk_sit = 'Land/Erschliessung/30/fluessig'::text AND a.neigung = 6)) * b.ant_los1 + (( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 8 AND a.vk_sit = 'Land/Erschliessung/30/dicht'::text AND a.neigung = 6)) * b.ant_los2 + (( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 8 AND a.vk_sit = 'Land/Erschliessung/30/gesaettigt'::text AND a.neigung = 6)) * b.ant_los3 + (( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 8 AND a.vk_sit = 'Land/Erschliessung/30/stop+go'::text AND a.neigung = 6)) * b.ant_los4) * 365::double precision / 1000::double precision
                    WHEN b.neigung = 0 AND b.vsit::text = 'Land/Erschliessung/40'::text THEN b.dtv2015_snf::double precision * ((( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 8 AND a.vk_sit = 'Land/Erschliessung/40/fluessig'::text AND a.neigung = 0)) * b.ant_los1 + (( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 8 AND a.vk_sit = 'Land/Erschliessung/40/dicht'::text AND a.neigung = 0)) * b.ant_los2 + (( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 8 AND a.vk_sit = 'Land/Erschliessung/40/gesaettigt'::text AND a.neigung = 0)) * b.ant_los3 + (( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 8 AND a.vk_sit = 'Land/Erschliessung/40/stop+go'::text AND a.neigung = 0)) * b.ant_los4) * 365::double precision / 1000::double precision
                    WHEN b.neigung = 2 AND b.vsit::text = 'Land/Erschliessung/40'::text THEN b.dtv2015_snf::double precision * ((( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 8 AND a.vk_sit = 'Land/Erschliessung/40/fluessig'::text AND a.neigung = 2)) * b.ant_los1 + (( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 8 AND a.vk_sit = 'Land/Erschliessung/40/dicht'::text AND a.neigung = 2)) * b.ant_los2 + (( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 8 AND a.vk_sit = 'Land/Erschliessung/40/gesaettigt'::text AND a.neigung = 2)) * b.ant_los3 + (( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 8 AND a.vk_sit = 'Land/Erschliessung/40/stop+go'::text AND a.neigung = 2)) * b.ant_los4) * 365::double precision / 1000::double precision
                    WHEN b.neigung = 4 AND b.vsit::text = 'Land/Erschliessung/40'::text THEN b.dtv2015_snf::double precision * ((( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 8 AND a.vk_sit = 'Land/Erschliessung/40/fluessig'::text AND a.neigung = 4)) * b.ant_los1 + (( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 8 AND a.vk_sit = 'Land/Erschliessung/40/dicht'::text AND a.neigung = 4)) * b.ant_los2 + (( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 8 AND a.vk_sit = 'Land/Erschliessung/40/gesaettigt'::text AND a.neigung = 4)) * b.ant_los3 + (( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 8 AND a.vk_sit = 'Land/Erschliessung/40/stop+go'::text AND a.neigung = 4)) * b.ant_los4) * 365::double precision / 1000::double precision
                    WHEN b.neigung = 6 AND b.vsit::text = 'Land/Erschliessung/40'::text THEN b.dtv2015_snf::double precision * ((( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 8 AND a.vk_sit = 'Land/Erschliessung/40/fluessig'::text AND a.neigung = 6)) * b.ant_los1 + (( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 8 AND a.vk_sit = 'Land/Erschliessung/40/dicht'::text AND a.neigung = 6)) * b.ant_los2 + (( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 8 AND a.vk_sit = 'Land/Erschliessung/40/gesaettigt'::text AND a.neigung = 6)) * b.ant_los3 + (( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 8 AND a.vk_sit = 'Land/Erschliessung/40/stop+go'::text AND a.neigung = 6)) * b.ant_los4) * 365::double precision / 1000::double precision
                    WHEN b.neigung = 0 AND b.vsit::text = 'Land/Erschliessung/50'::text THEN b.dtv2015_snf::double precision * ((( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                    ...
                    WHEN b.neigung = 0 AND b.vsit::text = 'Land/HVS/30'::text THEN b.dtv2015_snf::double precision * ((( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 8 AND a.vk_sit = 'Land/HVS/30/fluessig'::text AND a.neigung = 0)) * b.ant_los1 + (( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 8 AND a.vk_sit = 'Land/HVS/30/dicht'::text AND a.neigung = 0)) * b.ant_los2 + (( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 8 AND a.vk_sit = 'Land/HVS/30/gesaettigt'::text AND a.neigung = 0)) * b.ant_los3 + (( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 8 AND a.vk_sit = 'Land/HVS/30/stop+go'::text AND a.neigung = 0)) * b.ant_los4) * 365::double precision / 1000::double precision
                    WHEN b.neigung = 2 AND b.vsit::text = 'Land/HVS/30'::text THEN b.dtv2015_snf::double precision * ((( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 8 AND a.vk_sit = 'Land/HVS/30/fluessig'::text AND a.neigung = 2)) * b.ant_los1 + (( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 8 AND a.vk_sit = 'Land/HVS/30/dicht'::text AND a.neigung = 2)) * b.ant_los2 + (( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 8 AND a.vk_sit = 'Land/HVS/30/gesaettigt'::text AND a.neigung = 2)) * b.ant_los3 + (( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 8 AND a.vk_sit = 'Land/HVS/30/stop+go'::text AND a.neigung = 2)) * b.ant_los4) * 365::double precision / 1000::double precision
                    WHEN b.neigung = 4 AND b.vsit::text = 'Land/HVS/30'::text THEN b.dtv2015_snf::double precision * ((( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 8 AND a.vk_sit = 'Land/HVS/30/fluessig'::text AND a.neigung = 4)) * b.ant_los1 + (( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 8 AND a.vk_sit = 'Land/HVS/30/dicht'::text AND a.neigung = 4)) * b.ant_los2 + (( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 8 AND a.vk_sit = 'Land/HVS/30/gesaettigt'::text AND a.neigung = 4)) * b.ant_los3 + (( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 8 AND a.vk_sit = 'Land/HVS/30/stop+go'::text AND a.neigung = 4)) * b.ant_los4) * 365::double precision / 1000::double precision
                    WHEN b.neigung = 6 AND b.vsit::text = 'Land/HVS/30'::text THEN b.dtv2015_snf::double precision * ((( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 8 AND a.vk_sit = 'Land/HVS/30/fluessig'::text AND a.neigung = 6)) * b.ant_los1 + (( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 8 AND a.vk_sit = 'Land/HVS/30/dicht'::text AND a.neigung = 6)) * b.ant_los2 + (( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 8 AND a.vk_sit = 'Land/HVS/30/gesaettigt'::text AND a.neigung = 6)) * b.ant_los3 + (( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 8 AND a.vk_sit = 'Land/HVS/30/stop+go'::text AND a.neigung = 6)) * b.ant_los4) * 365::double precision / 1000::double precision
                    WHEN b.neigung = 0 AND b.vsit::text = 'Land/HVS/40'::text THEN b.dtv2015_snf::double precision * ((( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 8 AND a.vk_sit = 'Land/HVS/40/fluessig'::text AND a.neigung = 0)) * b.ant_los1 + (( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 8 AND a.vk_sit = 'Land/HVS/40/dicht'::text AND a.neigung = 0)) * b.ant_los2 + (( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 8 AND a.vk_sit = 'Land/HVS/40/gesaettigt'::text AND a.neigung = 0)) * b.ant_los3 + (( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 8 AND a.vk_sit = 'Land/HVS/40/stop+go'::text AND a.neigung = 0)) * b.ant_los4) * 365::double precision / 1000::double precision
                    WHEN b.neigung = 2 AND b.vsit::text = 'Land/HVS/40'::text THEN b.dtv2015_snf::double precision * ((( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 8 AND a.vk_sit = 'Land/HVS/40/fluessig'::text AND a.neigung = 2)) * b.ant_los1 + (( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 8 AND a.vk_sit = 'Land/HVS/40/dicht'::text AND a.neigung = 2)) * b.ant_los2 + (( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 8 AND a.vk_sit = 'Land/HVS/40/gesaettigt'::text AND a.neigung = 2)) * b.ant_los3 + (( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 8 AND a.vk_sit = 'Land/HVS/40/stop+go'::text AND a.neigung = 2)) * b.ant_los4) * 365::double precision / 1000::double precision
                    WHEN b.neigung = 4 AND b.vsit::text = 'Land/HVS/40'::text THEN b.dtv2015_snf::double precision * ((( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 8 AND a.vk_sit = 'Land/HVS/40/fluessig'::text AND a.neigung = 4)) * b.ant_los1 + (( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 8 AND a.vk_sit = 'Land/HVS/40/dicht'::text AND a.neigung = 4)) * b.ant_los2 + (( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 8 AND a.vk_sit = 'Land/HVS/40/gesaettigt'::text AND a.neigung = 4)) * b.ant_los3 + (( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 8 AND a.vk_sit = 'Land/HVS/40/stop+go'::text AND a.neigung = 4)) * b.ant_los4) * 365::double precision / 1000::double precision
                    WHEN b.neigung = 6 AND b.vsit::text = 'Land/HVS/40'::text THEN b.dtv2015_snf::double precision * ((( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 8 AND a.vk_sit = 'Land/HVS/40/fluessig'::text AND a.neigung = 6)) * b.ant_los1 + (( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 8 AND a.vk_sit = 'Land/HVS/40/dicht'::text AND a.neigung = 6)) * b.ant_los2 + (( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 8 AND a.vk_sit = 'Land/HVS/40/gesaettigt'::text AND a.neigung = 6)) * b.ant_los3 + (( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 8 AND a.vk_sit = 'Land/HVS/40/stop+go'::text AND a.neigung = 6)) * b.ant_los4) * 365::double precision / 1000::double precision
                    WHEN b.neigung = 0 AND b.vsit::text = 'Land/HVS/50'::text THEN b.dtv2015_snf::double precision * ((( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 8 AND a.vk_sit = 'Land/HVS/50/fluessig'::text AND a.neigung = 0)) * b.ant_los1 + (( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 8 AND a.vk_sit = 'Land/HVS/50/dicht'::text AND a.neigung = 0)) * b.ant_los2 + (( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 8 AND a.vk_sit = 'Land/HVS/50/gesaettigt'::text AND a.neigung = 0)) * b.ant_los3 + (( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 8 AND a.vk_sit = 'Land/HVS/50/stop+go'::text AND a.neigung = 0)) * b.ant_los4) * 365::double precision / 1000::double precision
                    WHEN b.neigung = 2 AND b.vsit::text = 'Land/HVS/50'::text THEN b.dtv2015_snf::double precision * ((( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 8 AND a.vk_sit = 'Land/HVS/50/fluessig'::text AND a.neigung = 2)) * b.ant_los1 + (( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 8 AND a.vk_sit = 'Land/HVS/50/dicht'::text AND a.neigung = 2)) * b.ant_los2 + (( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 8 AND a.vk_sit = 'Land/HVS/50/gesaettigt'::text AND a.neigung = 2)) * b.ant_los3 + (( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 8 AND a.vk_sit = 'Land/HVS/50/stop+go'::text AND a.neigung = 2)) * b.ant_los4) * 365::double precision / 1000::double precision
                    WHEN b.neigung = 4 AND b.vsit::text = 'Land/HVS/50'::text THEN b.dtv2015_snf::double precision * ((( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 8 AND a.vk_sit = 'Land/HVS/50/fluessig'::text AND a.neigung = 4)) * b.ant_los1 + (( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 8 AND a.vk_sit = 'Land/HVS/50/dicht'::text AND a.neigung = 4)) * b.ant_los2 + (( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 8 AND a.vk_sit = 'Land/HVS/50/gesaettigt'::text AND a.neigung = 4)) * b.ant_los3 + (( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 8 AND a.vk_sit = 'Land/HVS/50/stop+go'::text AND a.neigung = 4)) * b.ant_los4) * 365::double precision / 1000::double precision
                    WHEN b.neigung = 6 AND b.vsit::text = 'Land/HVS/50'::text THEN b.dtv2015_snf::double precision * ((( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 8 AND a.vk_sit = 'Land/HVS/50/fluessig'::text AND a.neigung = 6)) * b.ant_los1 + (( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 8 AND a.vk_sit = 'Land/HVS/50/dicht'::text AND a.neigung = 6)) * b.ant_los2 + (( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 8 AND a.vk_sit = 'Land/HVS/50/gesaettigt'::text AND a.neigung = 6)) * b.ant_los3 + (( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 8 AND a.vk_sit = 'Land/HVS/50/stop+go'::text AND a.neigung = 6)) * b.ant_los4) * 365::double precision / 1000::double precision
                    WHEN b.neigung = 0 AND b.vsit::text = 'Land/HVS/60'::text THEN b.dtv2015_snf::double precision * ((( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 8 AND a.vk_sit = 'Land/HVS/60/fluessig'::text AND a.neigung = 0)) * b.ant_los1 + (( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 8 AND a.vk_sit = 'Land/HVS/60/dicht'::text AND a.neigung = 0)) * b.ant_los2 + (( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 8 AND a.vk_sit = 'Land/HVS/60/gesaettigt'::text AND a.neigung = 0)) * b.ant_los3 + (( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 8 AND a.vk_sit = 'Land/HVS/60/stop+go'::text AND a.neigung = 0)) * b.ant_los4) * 365::double precision / 1000::double precision
                    WHEN b.neigung = 2 AND b.vsit::text = 'Land/HVS/60'::text THEN b.dtv2015_snf::double precision * ((( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 8 AND a.vk_sit = 'Land/HVS/60/fluessig'::text AND a.neigung = 2)) * b.ant_los1 + (( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 8 AND a.vk_sit = 'Land/HVS/60/dicht'::text AND a.neigung = 2)) * b.ant_los2 + (( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 8 AND a.vk_sit = 'Land/HVS/60/gesaettigt'::text AND a.neigung = 2)) * b.ant_los3 + (( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 8 AND a.vk_sit = 'Land/HVS/60/stop+go'::text AND a.neigung = 2)) * b.ant_los4) * 365::double precision / 1000::double precision
                    WHEN b.neigung = 4 AND b.vsit::text = 'Land/HVS/60'::text THEN b.dtv2015_snf::double precision * ((( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 8 AND a.vk_sit = 'Land/HVS/60/fluessig'::text AND a.neigung = 4)) * b.ant_los1 + (( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 8 AND a.vk_sit = 'Land/HVS/60/dicht'::text AND a.neigung = 4)) * b.ant_los2 + (( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 8 AND a.vk_sit = 'Land/HVS/60/gesaettigt'::text AND a.neigung = 4)) * b.ant_los3 + (( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 8 AND a.vk_sit = 'Land/HVS/60/stop+go'::text AND a.neigung = 4)) * b.ant_los4) * 365::double precision / 1000::double precision
                    WHEN b.neigung = 6 AND b.vsit::text = 'Land/HVS/60'::text THEN b.dtv2015_snf::double precision * ((( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 8 AND a.vk_sit = 'Land/HVS/60/fluessig'::text AND a.neigung = 6)) * b.ant_los1 + (( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 8 AND a.vk_sit = 'Land/HVS/60/dicht'::text AND a.neigung = 6)) * b.ant_los2 + (( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 8 AND a.vk_sit = 'Land/HVS/60/gesaettigt'::text AND a.neigung = 6)) * b.ant_los3 + (( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 8 AND a.vk_sit = 'Land/HVS/60/stop+go'::text AND a.neigung = 6)) * b.ant_los4) * 365::double precision / 1000::double precision
                    WHEN b.neigung = 0 AND b.vsit::text = 'Land/HVS/70'::text THEN b.dtv2015_snf::double precision * ((( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                    ...
                    WHEN b.neigung = 0 AND b.vsit::text = 'Land/Sammel/50'::text THEN b.dtv2015_snf::double precision * ((( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 8 AND a.vk_sit = 'Land/Sammel/50/fluessig'::text AND a.neigung = 0)) * b.ant_los1 + (( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 8 AND a.vk_sit = 'Land/Sammel/50/dicht'::text AND a.neigung = 0)) * b.ant_los2 + (( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 8 AND a.vk_sit = 'Land/Sammel/50/gesaettigt'::text AND a.neigung = 0)) * b.ant_los3 + (( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 8 AND a.vk_sit = 'Land/Sammel/50/stop+go'::text AND a.neigung = 0)) * b.ant_los4) * 365::double precision / 1000::double precision
                    WHEN b.neigung = 2 AND b.vsit::text = 'Land/Sammel/50'::text THEN b.dtv2015_snf::double precision * ((( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 8 AND a.vk_sit = 'Land/Sammel/50/fluessig'::text AND a.neigung = 2)) * b.ant_los1 + (( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 8 AND a.vk_sit = 'Land/Sammel/50/dicht'::text AND a.neigung = 2)) * b.ant_los2 + (( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 8 AND a.vk_sit = 'Land/Sammel/50/gesaettigt'::text AND a.neigung = 2)) * b.ant_los3 + (( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 8 AND a.vk_sit = 'Land/Sammel/50/stop+go'::text AND a.neigung = 2)) * b.ant_los4) * 365::double precision / 1000::double precision
                    WHEN b.neigung = 4 AND b.vsit::text = 'Land/Sammel/50'::text THEN b.dtv2015_snf::double precision * ((( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 8 AND a.vk_sit = 'Land/Sammel/50/fluessig'::text AND a.neigung = 4)) * b.ant_los1 + (( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 8 AND a.vk_sit = 'Land/Sammel/50/dicht'::text AND a.neigung = 4)) * b.ant_los2 + (( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 8 AND a.vk_sit = 'Land/Sammel/50/gesaettigt'::text AND a.neigung = 4)) * b.ant_los3 + (( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 8 AND a.vk_sit = 'Land/Sammel/50/stop+go'::text AND a.neigung = 4)) * b.ant_los4) * 365::double precision / 1000::double precision
                    WHEN b.neigung = 6 AND b.vsit::text = 'Land/Sammel/50'::text THEN b.dtv2015_snf::double precision * ((( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 8 AND a.vk_sit = 'Land/Sammel/50/fluessig'::text AND a.neigung = 6)) * b.ant_los1 + (( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 8 AND a.vk_sit = 'Land/Sammel/50/dicht'::text AND a.neigung = 6)) * b.ant_los2 + (( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 8 AND a.vk_sit = 'Land/Sammel/50/gesaettigt'::text AND a.neigung = 6)) * b.ant_los3 + (( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 8 AND a.vk_sit = 'Land/Sammel/50/stop+go'::text AND a.neigung = 6)) * b.ant_los4) * 365::double precision / 1000::double precision
                    WHEN b.neigung = 0 AND b.vsit::text = 'Land/Sammel/60'::text THEN b.dtv2015_snf::double precision * ((( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                ...
                CASE
                    ...
                    WHEN b.neigung = 0 AND b.vsit::text = 'Land/Erschliessung/30'::text THEN b.dtv2015_snf::double precision * ((( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 26 AND a.vk_sit = 'Land/Erschliessung/30/fluessig'::text AND a.neigung = 0)) * b.ant_los1 + (( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 26 AND a.vk_sit = 'Land/Erschliessung/30/dicht'::text AND a.neigung = 0)) * b.ant_los2 + (( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 26 AND a.vk_sit = 'Land/Erschliessung/30/gesaettigt'::text AND a.neigung = 0)) * b.ant_los3 + (( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 26 AND a.vk_sit = 'Land/Erschliessung/30/stop+go'::text AND a.neigung = 0)) * b.ant_los4) * 365::double precision / 1000::double precision
                    WHEN b.neigung = 2 AND b.vsit::text = 'Land/Erschliessung/30'::text THEN b.dtv2015_snf::double precision * ((( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 26 AND a.vk_sit = 'Land/Erschliessung/30/fluessig'::text AND a.neigung = 2)) * b.ant_los1 + (( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 26 AND a.vk_sit = 'Land/Erschliessung/30/dicht'::text AND a.neigung = 2)) * b.ant_los2 + (( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 26 AND a.vk_sit = 'Land/Erschliessung/30/gesaettigt'::text AND a.neigung = 2)) * b.ant_los3 + (( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 26 AND a.vk_sit = 'Land/Erschliessung/30/stop+go'::text AND a.neigung = 2)) * b.ant_los4) * 365::double precision / 1000::double precision
                    WHEN b.neigung = 4 AND b.vsit::text = 'Land/Erschliessung/30'::text THEN b.dtv2015_snf::double precision * ((( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 26 AND a.vk_sit = 'Land/Erschliessung/30/fluessig'::text AND a.neigung = 4)) * b.ant_los1 + (( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 26 AND a.vk_sit = 'Land/Erschliessung/30/dicht'::text AND a.neigung = 4)) * b.ant_los2 + (( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 26 AND a.vk_sit = 'Land/Erschliessung/30/gesaettigt'::text AND a.neigung = 4)) * b.ant_los3 + (( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 26 AND a.vk_sit = 'Land/Erschliessung/30/stop+go'::text AND a.neigung = 4)) * b.ant_los4) * 365::double precision / 1000::double precision
                    WHEN b.neigung = 6 AND b.vsit::text = 'Land/Erschliessung/30'::text THEN b.dtv2015_snf::double precision * ((( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 26 AND a.vk_sit = 'Land/Erschliessung/30/fluessig'::text AND a.neigung = 6)) * b.ant_los1 + (( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 26 AND a.vk_sit = 'Land/Erschliessung/30/dicht'::text AND a.neigung = 6)) * b.ant_los2 + (( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 26 AND a.vk_sit = 'Land/Erschliessung/30/gesaettigt'::text AND a.neigung = 6)) * b.ant_los3 + (( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 26 AND a.vk_sit = 'Land/Erschliessung/30/stop+go'::text AND a.neigung = 6)) * b.ant_los4) * 365::double precision / 1000::double precision
                    WHEN b.neigung = 0 AND b.vsit::text = 'Land/Erschliessung/40'::text THEN b.dtv2015_snf::double precision * ((( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 26 AND a.vk_sit = 'Land/Erschliessung/40/fluessig'::text AND a.neigung = 0)) * b.ant_los1 + (( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 26 AND a.vk_sit = 'Land/Erschliessung/40/dicht'::text AND a.neigung = 0)) * b.ant_los2 + (( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 26 AND a.vk_sit = 'Land/Erschliessung/40/gesaettigt'::text AND a.neigung = 0)) * b.ant_los3 + (( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 26 AND a.vk_sit = 'Land/Erschliessung/40/stop+go'::text AND a.neigung = 0)) * b.ant_los4) * 365::double precision / 1000::double precision
                    WHEN b.neigung = 2 AND b.vsit::text = 'Land/Erschliessung/40'::text THEN b.dtv2015_snf::double precision * ((( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 26 AND a.vk_sit = 'Land/Erschliessung/40/fluessig'::text AND a.neigung = 2)) * b.ant_los1 + (( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 26 AND a.vk_sit = 'Land/Erschliessung/40/dicht'::text AND a.neigung = 2)) * b.ant_los2 + (( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 26 AND a.vk_sit = 'Land/Erschliessung/40/gesaettigt'::text AND a.neigung = 2)) * b.ant_los3 + (( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 26 AND a.vk_sit = 'Land/Erschliessung/40/stop+go'::text AND a.neigung = 2)) * b.ant_los4) * 365::double precision / 1000::double precision
                    WHEN b.neigung = 4 AND b.vsit::text = 'Land/Erschliessung/40'::text THEN b.dtv2015_snf::double precision * ((( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 26 AND a.vk_sit = 'Land/Erschliessung/40/fluessig'::text AND a.neigung = 4)) * b.ant_los1 + (( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 26 AND a.vk_sit = 'Land/Erschliessung/40/dicht'::text AND a.neigung = 4)) * b.ant_los2 + (( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 26 AND a.vk_sit = 'Land/Erschliessung/40/gesaettigt'::text AND a.neigung = 4)) * b.ant_los3 + (( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 26 AND a.vk_sit = 'Land/Erschliessung/40/stop+go'::text AND a.neigung = 4)) * b.ant_los4) * 365::double precision / 1000::double precision
                    WHEN b.neigung = 6 AND b.vsit::text = 'Land/Erschliessung/40'::text THEN b.dtv2015_snf::double precision * ((( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 26 AND a.vk_sit = 'Land/Erschliessung/40/fluessig'::text AND a.neigung = 6)) * b.ant_los1 + (( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 26 AND a.vk_sit = 'Land/Erschliessung/40/dicht'::text AND a.neigung = 6)) * b.ant_los2 + (( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 26 AND a.vk_sit = 'Land/Erschliessung/40/gesaettigt'::text AND a.neigung = 6)) * b.ant_los3 + (( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 26 AND a.vk_sit = 'Land/Erschliessung/40/stop+go'::text AND a.neigung = 6)) * b.ant_los4) * 365::double precision / 1000::double precision
                    WHEN b.neigung = 0 AND b.vsit::text = 'Land/Erschliessung/50'::text THEN b.dtv2015_snf::double precision * ((( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                    ...
                    WHEN b.neigung = 0 AND b.vsit::text = 'Land/HVS/30'::text THEN b.dtv2015_snf::double precision * ((( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 26 AND a.vk_sit = 'Land/HVS/30/fluessig'::text AND a.neigung = 0)) * b.ant_los1 + (( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 26 AND a.vk_sit = 'Land/HVS/30/dicht'::text AND a.neigung = 0)) * b.ant_los2 + (( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 26 AND a.vk_sit = 'Land/HVS/30/gesaettigt'::text AND a.neigung = 0)) * b.ant_los3 + (( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 26 AND a.vk_sit = 'Land/HVS/30/stop+go'::text AND a.neigung = 0)) * b.ant_los4) * 365::double precision / 1000::double precision
                    WHEN b.neigung = 2 AND b.vsit::text = 'Land/HVS/30'::text THEN b.dtv2015_snf::double precision * ((( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 26 AND a.vk_sit = 'Land/HVS/30/fluessig'::text AND a.neigung = 2)) * b.ant_los1 + (( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 26 AND a.vk_sit = 'Land/HVS/30/dicht'::text AND a.neigung = 2)) * b.ant_los2 + (( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 26 AND a.vk_sit = 'Land/HVS/30/gesaettigt'::text AND a.neigung = 2)) * b.ant_los3 + (( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 26 AND a.vk_sit = 'Land/HVS/30/stop+go'::text AND a.neigung = 2)) * b.ant_los4) * 365::double precision / 1000::double precision
                    WHEN b.neigung = 4 AND b.vsit::text = 'Land/HVS/30'::text THEN b.dtv2015_snf::double precision * ((( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 26 AND a.vk_sit = 'Land/HVS/30/fluessig'::text AND a.neigung = 4)) * b.ant_los1 + (( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 26 AND a.vk_sit = 'Land/HVS/30/dicht'::text AND a.neigung = 4)) * b.ant_los2 + (( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 26 AND a.vk_sit = 'Land/HVS/30/gesaettigt'::text AND a.neigung = 4)) * b.ant_los3 + (( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 26 AND a.vk_sit = 'Land/HVS/30/stop+go'::text AND a.neigung = 4)) * b.ant_los4) * 365::double precision / 1000::double precision
                    WHEN b.neigung = 6 AND b.vsit::text = 'Land/HVS/30'::text THEN b.dtv2015_snf::double precision * ((( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 26 AND a.vk_sit = 'Land/HVS/30/fluessig'::text AND a.neigung = 6)) * b.ant_los1 + (( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 26 AND a.vk_sit = 'Land/HVS/30/dicht'::text AND a.neigung = 6)) * b.ant_los2 + (( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 26 AND a.vk_sit = 'Land/HVS/30/gesaettigt'::text AND a.neigung = 6)) * b.ant_los3 + (( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 26 AND a.vk_sit = 'Land/HVS/30/stop+go'::text AND a.neigung = 6)) * b.ant_los4) * 365::double precision / 1000::double precision
                    WHEN b.neigung = 0 AND b.vsit::text = 'Land/HVS/40'::text THEN b.dtv2015_snf::double precision * ((( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 26 AND a.vk_sit = 'Land/HVS/40/fluessig'::text AND a.neigung = 0)) * b.ant_los1 + (( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 26 AND a.vk_sit = 'Land/HVS/40/dicht'::text AND a.neigung = 0)) * b.ant_los2 + (( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 26 AND a.vk_sit = 'Land/HVS/40/gesaettigt'::text AND a.neigung = 0)) * b.ant_los3 + (( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 26 AND a.vk_sit = 'Land/HVS/40/stop+go'::text AND a.neigung = 0)) * b.ant_los4) * 365::double precision / 1000::double precision
                    WHEN b.neigung = 2 AND b.vsit::text = 'Land/HVS/40'::text THEN b.dtv2015_snf::double precision * ((( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 26 AND a.vk_sit = 'Land/HVS/40/fluessig'::text AND a.neigung = 2)) * b.ant_los1 + (( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 26 AND a.vk_sit = 'Land/HVS/40/dicht'::text AND a.neigung = 2)) * b.ant_los2 + (( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 26 AND a.vk_sit = 'Land/HVS/40/gesaettigt'::text AND a.neigung = 2)) * b.ant_los3 + (( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 26 AND a.vk_sit = 'Land/HVS/40/stop+go'::text AND a.neigung = 2)) * b.ant_los4) * 365::double precision / 1000::double precision
                    WHEN b.neigung = 4 AND b.vsit::text = 'Land/HVS/40'::text THEN b.dtv2015_snf::double precision * ((( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 26 AND a.vk_sit = 'Land/HVS/40/fluessig'::text AND a.neigung = 4)) * b.ant_los1 + (( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 26 AND a.vk_sit = 'Land/HVS/40/dicht'::text AND a.neigung = 4)) * b.ant_los2 + (( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 26 AND a.vk_sit = 'Land/HVS/40/gesaettigt'::text AND a.neigung = 4)) * b.ant_los3 + (( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 26 AND a.vk_sit = 'Land/HVS/40/stop+go'::text AND a.neigung = 4)) * b.ant_los4) * 365::double precision / 1000::double precision
                    WHEN b.neigung = 6 AND b.vsit::text = 'Land/HVS/40'::text THEN b.dtv2015_snf::double precision * ((( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 26 AND a.vk_sit = 'Land/HVS/40/fluessig'::text AND a.neigung = 6)) * b.ant_los1 + (( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 26 AND a.vk_sit = 'Land/HVS/40/dicht'::text AND a.neigung = 6)) * b.ant_los2 + (( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 26 AND a.vk_sit = 'Land/HVS/40/gesaettigt'::text AND a.neigung = 6)) * b.ant_los3 + (( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 26 AND a.vk_sit = 'Land/HVS/40/stop+go'::text AND a.neigung = 6)) * b.ant_los4) * 365::double precision / 1000::double precision
                    WHEN b.neigung = 0 AND b.vsit::text = 'Land/HVS/50'::text THEN b.dtv2015_snf::double precision * ((( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 26 AND a.vk_sit = 'Land/HVS/50/fluessig'::text AND a.neigung = 0)) * b.ant_los1 + (( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 26 AND a.vk_sit = 'Land/HVS/50/dicht'::text AND a.neigung = 0)) * b.ant_los2 + (( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 26 AND a.vk_sit = 'Land/HVS/50/gesaettigt'::text AND a.neigung = 0)) * b.ant_los3 + (( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 26 AND a.vk_sit = 'Land/HVS/50/stop+go'::text AND a.neigung = 0)) * b.ant_los4) * 365::double precision / 1000::double precision
                    WHEN b.neigung = 2 AND b.vsit::text = 'Land/HVS/50'::text THEN b.dtv2015_snf::double precision * ((( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 26 AND a.vk_sit = 'Land/HVS/50/fluessig'::text AND a.neigung = 2)) * b.ant_los1 + (( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 26 AND a.vk_sit = 'Land/HVS/50/dicht'::text AND a.neigung = 2)) * b.ant_los2 + (( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 26 AND a.vk_sit = 'Land/HVS/50/gesaettigt'::text AND a.neigung = 2)) * b.ant_los3 + (( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 26 AND a.vk_sit = 'Land/HVS/50/stop+go'::text AND a.neigung = 2)) * b.ant_los4) * 365::double precision / 1000::double precision
                    WHEN b.neigung = 4 AND b.vsit::text = 'Land/HVS/50'::text THEN b.dtv2015_snf::double precision * ((( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 26 AND a.vk_sit = 'Land/HVS/50/fluessig'::text AND a.neigung = 4)) * b.ant_los1 + (( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 26 AND a.vk_sit = 'Land/HVS/50/dicht'::text AND a.neigung = 4)) * b.ant_los2 + (( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 26 AND a.vk_sit = 'Land/HVS/50/gesaettigt'::text AND a.neigung = 4)) * b.ant_los3 + (( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 26 AND a.vk_sit = 'Land/HVS/50/stop+go'::text AND a.neigung = 4)) * b.ant_los4) * 365::double precision / 1000::double precision
                    WHEN b.neigung = 6 AND b.vsit::text = 'Land/HVS/50'::text THEN b.dtv2015_snf::double precision * ((( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 26 AND a.vk_sit = 'Land/HVS/50/fluessig'::text AND a.neigung = 6)) * b.ant_los1 + (( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 26 AND a.vk_sit = 'Land/HVS/50/dicht'::text AND a.neigung = 6)) * b.ant_los2 + (( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 26 AND a.vk_sit = 'Land/HVS/50/gesaettigt'::text AND a.neigung = 6)) * b.ant_los3 + (( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 26 AND a.vk_sit = 'Land/HVS/50/stop+go'::text AND a.neigung = 6)) * b.ant_los4) * 365::double precision / 1000::double precision
                    WHEN b.neigung = 0 AND b.vsit::text = 'Land/HVS/60'::text THEN b.dtv2015_snf::double precision * ((( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 26 AND a.vk_sit = 'Land/HVS/60/fluessig'::text AND a.neigung = 0)) * b.ant_los1 + (( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 26 AND a.vk_sit = 'Land/HVS/60/dicht'::text AND a.neigung = 0)) * b.ant_los2 + (( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 26 AND a.vk_sit = 'Land/HVS/60/gesaettigt'::text AND a.neigung = 0)) * b.ant_los3 + (( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 26 AND a.vk_sit = 'Land/HVS/60/stop+go'::text AND a.neigung = 0)) * b.ant_los4) * 365::double precision / 1000::double precision
                    WHEN b.neigung = 2 AND b.vsit::text = 'Land/HVS/60'::text THEN b.dtv2015_snf::double precision * ((( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 26 AND a.vk_sit = 'Land/HVS/60/fluessig'::text AND a.neigung = 2)) * b.ant_los1 + (( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 26 AND a.vk_sit = 'Land/HVS/60/dicht'::text AND a.neigung = 2)) * b.ant_los2 + (( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 26 AND a.vk_sit = 'Land/HVS/60/gesaettigt'::text AND a.neigung = 2)) * b.ant_los3 + (( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 26 AND a.vk_sit = 'Land/HVS/60/stop+go'::text AND a.neigung = 2)) * b.ant_los4) * 365::double precision / 1000::double precision
                    WHEN b.neigung = 4 AND b.vsit::text = 'Land/HVS/60'::text THEN b.dtv2015_snf::double precision * ((( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 26 AND a.vk_sit = 'Land/HVS/60/fluessig'::text AND a.neigung = 4)) * b.ant_los1 + (( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 26 AND a.vk_sit = 'Land/HVS/60/dicht'::text AND a.neigung = 4)) * b.ant_los2 + (( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 26 AND a.vk_sit = 'Land/HVS/60/gesaettigt'::text AND a.neigung = 4)) * b.ant_los3 + (( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 26 AND a.vk_sit = 'Land/HVS/60/stop+go'::text AND a.neigung = 4)) * b.ant_los4) * 365::double precision / 1000::double precision
                    WHEN b.neigung = 6 AND b.vsit::text = 'Land/HVS/60'::text THEN b.dtv2015_snf::double precision * ((( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 26 AND a.vk_sit = 'Land/HVS/60/fluessig'::text AND a.neigung = 6)) * b.ant_los1 + (( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 26 AND a.vk_sit = 'Land/HVS/60/dicht'::text AND a.neigung = 6)) * b.ant_los2 + (( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 26 AND a.vk_sit = 'Land/HVS/60/gesaettigt'::text AND a.neigung = 6)) * b.ant_los3 + (( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 26 AND a.vk_sit = 'Land/HVS/60/stop+go'::text AND a.neigung = 6)) * b.ant_los4) * 365::double precision / 1000::double precision
                    WHEN b.neigung = 0 AND b.vsit::text = 'Land/HVS/70'::text THEN b.dtv2015_snf::double precision * ((( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                    ...
                    WHEN b.neigung = 0 AND b.vsit::text = 'Land/Sammel/50'::text THEN b.dtv2015_snf::double precision * ((( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 26 AND a.vk_sit = 'Land/Sammel/50/fluessig'::text AND a.neigung = 0)) * b.ant_los1 + (( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 26 AND a.vk_sit = 'Land/Sammel/50/dicht'::text AND a.neigung = 0)) * b.ant_los2 + (( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 26 AND a.vk_sit = 'Land/Sammel/50/gesaettigt'::text AND a.neigung = 0)) * b.ant_los3 + (( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 26 AND a.vk_sit = 'Land/Sammel/50/stop+go'::text AND a.neigung = 0)) * b.ant_los4) * 365::double precision / 1000::double precision
                    WHEN b.neigung = 2 AND b.vsit::text = 'Land/Sammel/50'::text THEN b.dtv2015_snf::double precision * ((( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 26 AND a.vk_sit = 'Land/Sammel/50/fluessig'::text AND a.neigung = 2)) * b.ant_los1 + (( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 26 AND a.vk_sit = 'Land/Sammel/50/dicht'::text AND a.neigung = 2)) * b.ant_los2 + (( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 26 AND a.vk_sit = 'Land/Sammel/50/gesaettigt'::text AND a.neigung = 2)) * b.ant_los3 + (( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 26 AND a.vk_sit = 'Land/Sammel/50/stop+go'::text AND a.neigung = 2)) * b.ant_los4) * 365::double precision / 1000::double precision
                    WHEN b.neigung = 4 AND b.vsit::text = 'Land/Sammel/50'::text THEN b.dtv2015_snf::double precision * ((( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 26 AND a.vk_sit = 'Land/Sammel/50/fluessig'::text AND a.neigung = 4)) * b.ant_los1 + (( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 26 AND a.vk_sit = 'Land/Sammel/50/dicht'::text AND a.neigung = 4)) * b.ant_los2 + (( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 26 AND a.vk_sit = 'Land/Sammel/50/gesaettigt'::text AND a.neigung = 4)) * b.ant_los3 + (( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 26 AND a.vk_sit = 'Land/Sammel/50/stop+go'::text AND a.neigung = 4)) * b.ant_los4) * 365::double precision / 1000::double precision
                    WHEN b.neigung = 6 AND b.vsit::text = 'Land/Sammel/50'::text THEN b.dtv2015_snf::double precision * ((( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 26 AND a.vk_sit = 'Land/Sammel/50/fluessig'::text AND a.neigung = 6)) * b.ant_los1 + (( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 26 AND a.vk_sit = 'Land/Sammel/50/dicht'::text AND a.neigung = 6)) * b.ant_los2 + (( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 26 AND a.vk_sit = 'Land/Sammel/50/gesaettigt'::text AND a.neigung = 6)) * b.ant_los3 + (( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 26 AND a.vk_sit = 'Land/Sammel/50/stop+go'::text AND a.neigung = 6)) * b.ant_los4) * 365::double precision / 1000::double precision
                    WHEN b.neigung = 0 AND b.vsit::text = 'Land/Sammel/60'::text THEN b.dtv2015_snf::double precision * ((( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                ...
                CASE
                    ...
                    WHEN b.neigung = 0 AND b.vsit::text = 'Land/Erschliessung/30'::text THEN b.dtv2015_snf::double precision * ((( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 7 AND a.vk_sit = 'Land/Erschliessung/30/fluessig'::text AND a.neigung = 0)) * b.ant_los1 + (( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 7 AND a.vk_sit = 'Land/Erschliessung/30/dicht'::text AND a.neigung = 0)) * b.ant_los2 + (( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 7 AND a.vk_sit = 'Land/Erschliessung/30/gesaettigt'::text AND a.neigung = 0)) * b.ant_los3 + (( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 7 AND a.vk_sit = 'Land/Erschliessung/30/stop+go'::text AND a.neigung = 0)) * b.ant_los4) * 365::double precision / 1000::double precision
                    WHEN b.neigung = 2 AND b.vsit::text = 'Land/Erschliessung/30'::text THEN b.dtv2015_snf::double precision * ((( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 7 AND a.vk_sit = 'Land/Erschliessung/30/fluessig'::text AND a.neigung = 2)) * b.ant_los1 + (( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 7 AND a.vk_sit = 'Land/Erschliessung/30/dicht'::text AND a.neigung = 2)) * b.ant_los2 + (( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 7 AND a.vk_sit = 'Land/Erschliessung/30/gesaettigt'::text AND a.neigung = 2)) * b.ant_los3 + (( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 7 AND a.vk_sit = 'Land/Erschliessung/30/stop+go'::text AND a.neigung = 2)) * b.ant_los4) * 365::double precision / 1000::double precision
                    WHEN b.neigung = 4 AND b.vsit::text = 'Land/Erschliessung/30'::text THEN b.dtv2015_snf::double precision * ((( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 7 AND a.vk_sit = 'Land/Erschliessung/30/fluessig'::text AND a.neigung = 4)) * b.ant_los1 + (( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 7 AND a.vk_sit = 'Land/Erschliessung/30/dicht'::text AND a.neigung = 4)) * b.ant_los2 + (( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 7 AND a.vk_sit = 'Land/Erschliessung/30/gesaettigt'::text AND a.neigung = 4)) * b.ant_los3 + (( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 7 AND a.vk_sit = 'Land/Erschliessung/30/stop+go'::text AND a.neigung = 4)) * b.ant_los4) * 365::double precision / 1000::double precision
                    WHEN b.neigung = 6 AND b.vsit::text = 'Land/Erschliessung/30'::text THEN b.dtv2015_snf::double precision * ((( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 7 AND a.vk_sit = 'Land/Erschliessung/30/fluessig'::text AND a.neigung = 6)) * b.ant_los1 + (( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 7 AND a.vk_sit = 'Land/Erschliessung/30/dicht'::text AND a.neigung = 6)) * b.ant_los2 + (( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 7 AND a.vk_sit = 'Land/Erschliessung/30/gesaettigt'::text AND a.neigung = 6)) * b.ant_los3 + (( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 7 AND a.vk_sit = 'Land/Erschliessung/30/stop+go'::text AND a.neigung = 6)) * b.ant_los4) * 365::double precision / 1000::double precision
                    WHEN b.neigung = 0 AND b.vsit::text = 'Land/Erschliessung/40'::text THEN b.dtv2015_snf::double precision * ((( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 7 AND a.vk_sit = 'Land/Erschliessung/40/fluessig'::text AND a.neigung = 0)) * b.ant_los1 + (( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 7 AND a.vk_sit = 'Land/Erschliessung/40/dicht'::text AND a.neigung = 0)) * b.ant_los2 + (( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 7 AND a.vk_sit = 'Land/Erschliessung/40/gesaettigt'::text AND a.neigung = 0)) * b.ant_los3 + (( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 7 AND a.vk_sit = 'Land/Erschliessung/40/stop+go'::text AND a.neigung = 0)) * b.ant_los4) * 365::double precision / 1000::double precision
                    WHEN b.neigung = 2 AND b.vsit::text = 'Land/Erschliessung/40'::text THEN b.dtv2015_snf::double precision * ((( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 7 AND a.vk_sit = 'Land/Erschliessung/40/fluessig'::text AND a.neigung = 2)) * b.ant_los1 + (( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 7 AND a.vk_sit = 'Land/Erschliessung/40/dicht'::text AND a.neigung = 2)) * b.ant_los2 + (( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 7 AND a.vk_sit = 'Land/Erschliessung/40/gesaettigt'::text AND a.neigung = 2)) * b.ant_los3 + (( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 7 AND a.vk_sit = 'Land/Erschliessung/40/stop+go'::text AND a.neigung = 2)) * b.ant_los4) * 365::double precision / 1000::double precision
                    WHEN b.neigung = 4 AND b.vsit::text = 'Land/Erschliessung/40'::text THEN b.dtv2015_snf::double precision * ((( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 7 AND a.vk_sit = 'Land/Erschliessung/40/fluessig'::text AND a.neigung = 4)) * b.ant_los1 + (( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 7 AND a.vk_sit = 'Land/Erschliessung/40/dicht'::text AND a.neigung = 4)) * b.ant_los2 + (( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 7 AND a.vk_sit = 'Land/Erschliessung/40/gesaettigt'::text AND a.neigung = 4)) * b.ant_los3 + (( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 7 AND a.vk_sit = 'Land/Erschliessung/40/stop+go'::text AND a.neigung = 4)) * b.ant_los4) * 365::double precision / 1000::double precision
                    WHEN b.neigung = 6 AND b.vsit::text = 'Land/Erschliessung/40'::text THEN b.dtv2015_snf::double precision * ((( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 7 AND a.vk_sit = 'Land/Erschliessung/40/fluessig'::text AND a.neigung = 6)) * b.ant_los1 + (( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 7 AND a.vk_sit = 'Land/Erschliessung/40/dicht'::text AND a.neigung = 6)) * b.ant_los2 + (( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 7 AND a.vk_sit = 'Land/Erschliessung/40/gesaettigt'::text AND a.neigung = 6)) * b.ant_los3 + (( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 7 AND a.vk_sit = 'Land/Erschliessung/40/stop+go'::text AND a.neigung = 6)) * b.ant_los4) * 365::double precision / 1000::double precision
                    WHEN b.neigung = 0 AND b.vsit::text = 'Land/Erschliessung/50'::text THEN b.dtv2015_snf::double precision * ((( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                    ...
                    WHEN b.neigung = 0 AND b.vsit::text = 'Land/HVS/30'::text THEN b.dtv2015_snf::double precision * ((( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 7 AND a.vk_sit = 'Land/HVS/30/fluessig'::text AND a.neigung = 0)) * b.ant_los1 + (( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 7 AND a.vk_sit = 'Land/HVS/30/dicht'::text AND a.neigung = 0)) * b.ant_los2 + (( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 7 AND a.vk_sit = 'Land/HVS/30/gesaettigt'::text AND a.neigung = 0)) * b.ant_los3 + (( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 7 AND a.vk_sit = 'Land/HVS/30/stop+go'::text AND a.neigung = 0)) * b.ant_los4) * 365::double precision / 1000::double precision
                    WHEN b.neigung = 2 AND b.vsit::text = 'Land/HVS/30'::text THEN b.dtv2015_snf::double precision * ((( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 7 AND a.vk_sit = 'Land/HVS/30/fluessig'::text AND a.neigung = 2)) * b.ant_los1 + (( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 7 AND a.vk_sit = 'Land/HVS/30/dicht'::text AND a.neigung = 2)) * b.ant_los2 + (( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 7 AND a.vk_sit = 'Land/HVS/30/gesaettigt'::text AND a.neigung = 2)) * b.ant_los3 + (( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 7 AND a.vk_sit = 'Land/HVS/30/stop+go'::text AND a.neigung = 2)) * b.ant_los4) * 365::double precision / 1000::double precision
                    WHEN b.neigung = 4 AND b.vsit::text = 'Land/HVS/30'::text THEN b.dtv2015_snf::double precision * ((( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 7 AND a.vk_sit = 'Land/HVS/30/fluessig'::text AND a.neigung = 4)) * b.ant_los1 + (( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 7 AND a.vk_sit = 'Land/HVS/30/dicht'::text AND a.neigung = 4)) * b.ant_los2 + (( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 7 AND a.vk_sit = 'Land/HVS/30/gesaettigt'::text AND a.neigung = 4)) * b.ant_los3 + (( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 7 AND a.vk_sit = 'Land/HVS/30/stop+go'::text AND a.neigung = 4)) * b.ant_los4) * 365::double precision / 1000::double precision
                    WHEN b.neigung = 6 AND b.vsit::text = 'Land/HVS/30'::text THEN b.dtv2015_snf::double precision * ((( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 7 AND a.vk_sit = 'Land/HVS/30/fluessig'::text AND a.neigung = 6)) * b.ant_los1 + (( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 7 AND a.vk_sit = 'Land/HVS/30/dicht'::text AND a.neigung = 6)) * b.ant_los2 + (( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 7 AND a.vk_sit = 'Land/HVS/30/gesaettigt'::text AND a.neigung = 6)) * b.ant_los3 + (( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 7 AND a.vk_sit = 'Land/HVS/30/stop+go'::text AND a.neigung = 6)) * b.ant_los4) * 365::double precision / 1000::double precision
                    WHEN b.neigung = 0 AND b.vsit::text = 'Land/HVS/40'::text THEN b.dtv2015_snf::double precision * ((( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 7 AND a.vk_sit = 'Land/HVS/40/fluessig'::text AND a.neigung = 0)) * b.ant_los1 + (( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 7 AND a.vk_sit = 'Land/HVS/40/dicht'::text AND a.neigung = 0)) * b.ant_los2 + (( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 7 AND a.vk_sit = 'Land/HVS/40/gesaettigt'::text AND a.neigung = 0)) * b.ant_los3 + (( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 7 AND a.vk_sit = 'Land/HVS/40/stop+go'::text AND a.neigung = 0)) * b.ant_los4) * 365::double precision / 1000::double precision
                    WHEN b.neigung = 2 AND b.vsit::text = 'Land/HVS/40'::text THEN b.dtv2015_snf::double precision * ((( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 7 AND a.vk_sit = 'Land/HVS/40/fluessig'::text AND a.neigung = 2)) * b.ant_los1 + (( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 7 AND a.vk_sit = 'Land/HVS/40/dicht'::text AND a.neigung = 2)) * b.ant_los2 + (( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 7 AND a.vk_sit = 'Land/HVS/40/gesaettigt'::text AND a.neigung = 2)) * b.ant_los3 + (( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 7 AND a.vk_sit = 'Land/HVS/40/stop+go'::text AND a.neigung = 2)) * b.ant_los4) * 365::double precision / 1000::double precision
                    WHEN b.neigung = 4 AND b.vsit::text = 'Land/HVS/40'::text THEN b.dtv2015_snf::double precision * ((( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 7 AND a.vk_sit = 'Land/HVS/40/fluessig'::text AND a.neigung = 4)) * b.ant_los1 + (( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 7 AND a.vk_sit = 'Land/HVS/40/dicht'::text AND a.neigung = 4)) * b.ant_los2 + (( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 7 AND a.vk_sit = 'Land/HVS/40/gesaettigt'::text AND a.neigung = 4)) * b.ant_los3 + (( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 7 AND a.vk_sit = 'Land/HVS/40/stop+go'::text AND a.neigung = 4)) * b.ant_los4) * 365::double precision / 1000::double precision
                    WHEN b.neigung = 6 AND b.vsit::text = 'Land/HVS/40'::text THEN b.dtv2015_snf::double precision * ((( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 7 AND a.vk_sit = 'Land/HVS/40/fluessig'::text AND a.neigung = 6)) * b.ant_los1 + (( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 7 AND a.vk_sit = 'Land/HVS/40/dicht'::text AND a.neigung = 6)) * b.ant_los2 + (( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 7 AND a.vk_sit = 'Land/HVS/40/gesaettigt'::text AND a.neigung = 6)) * b.ant_los3 + (( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 7 AND a.vk_sit = 'Land/HVS/40/stop+go'::text AND a.neigung = 6)) * b.ant_los4) * 365::double precision / 1000::double precision
                    WHEN b.neigung = 0 AND b.vsit::text = 'Land/HVS/50'::text THEN b.dtv2015_snf::double precision * ((( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 7 AND a.vk_sit = 'Land/HVS/50/fluessig'::text AND a.neigung = 0)) * b.ant_los1 + (( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 7 AND a.vk_sit = 'Land/HVS/50/dicht'::text AND a.neigung = 0)) * b.ant_los2 + (( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 7 AND a.vk_sit = 'Land/HVS/50/gesaettigt'::text AND a.neigung = 0)) * b.ant_los3 + (( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 7 AND a.vk_sit = 'Land/HVS/50/stop+go'::text AND a.neigung = 0)) * b.ant_los4) * 365::double precision / 1000::double precision
                    WHEN b.neigung = 2 AND b.vsit::text = 'Land/HVS/50'::text THEN b.dtv2015_snf::double precision * ((( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 7 AND a.vk_sit = 'Land/HVS/50/fluessig'::text AND a.neigung = 2)) * b.ant_los1 + (( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 7 AND a.vk_sit = 'Land/HVS/50/dicht'::text AND a.neigung = 2)) * b.ant_los2 + (( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 7 AND a.vk_sit = 'Land/HVS/50/gesaettigt'::text AND a.neigung = 2)) * b.ant_los3 + (( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 7 AND a.vk_sit = 'Land/HVS/50/stop+go'::text AND a.neigung = 2)) * b.ant_los4) * 365::double precision / 1000::double precision
                    WHEN b.neigung = 4 AND b.vsit::text = 'Land/HVS/50'::text THEN b.dtv2015_snf::double precision * ((( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 7 AND a.vk_sit = 'Land/HVS/50/fluessig'::text AND a.neigung = 4)) * b.ant_los1 + (( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 7 AND a.vk_sit = 'Land/HVS/50/dicht'::text AND a.neigung = 4)) * b.ant_los2 + (( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 7 AND a.vk_sit = 'Land/HVS/50/gesaettigt'::text AND a.neigung = 4)) * b.ant_los3 + (( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 7 AND a.vk_sit = 'Land/HVS/50/stop+go'::text AND a.neigung = 4)) * b.ant_los4) * 365::double precision / 1000::double precision
                    WHEN b.neigung = 6 AND b.vsit::text = 'Land/HVS/50'::text THEN b.dtv2015_snf::double precision * ((( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 7 AND a.vk_sit = 'Land/HVS/50/fluessig'::text AND a.neigung = 6)) * b.ant_los1 + (( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 7 AND a.vk_sit = 'Land/HVS/50/dicht'::text AND a.neigung = 6)) * b.ant_los2 + (( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 7 AND a.vk_sit = 'Land/HVS/50/gesaettigt'::text AND a.neigung = 6)) * b.ant_los3 + (( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 7 AND a.vk_sit = 'Land/HVS/50/stop+go'::text AND a.neigung = 6)) * b.ant_los4) * 365::double precision / 1000::double precision
                    WHEN b.neigung = 0 AND b.vsit::text = 'Land/HVS/60'::text THEN b.dtv2015_snf::double precision * ((( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 7 AND a.vk_sit = 'Land/HVS/60/fluessig'::text AND a.neigung = 0)) * b.ant_los1 + (( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 7 AND a.vk_sit = 'Land/HVS/60/dicht'::text AND a.neigung = 0)) * b.ant_los2 + (( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 7 AND a.vk_sit = 'Land/HVS/60/gesaettigt'::text AND a.neigung = 0)) * b.ant_los3 + (( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 7 AND a.vk_sit = 'Land/HVS/60/stop+go'::text AND a.neigung = 0)) * b.ant_los4) * 365::double precision / 1000::double precision
                    WHEN b.neigung = 2 AND b.vsit::text = 'Land/HVS/60'::text THEN b.dtv2015_snf::double precision * ((( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 7 AND a.vk_sit = 'Land/HVS/60/fluessig'::text AND a.neigung = 2)) * b.ant_los1 + (( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 7 AND a.vk_sit = 'Land/HVS/60/dicht'::text AND a.neigung = 2)) * b.ant_los2 + (( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 7 AND a.vk_sit = 'Land/HVS/60/gesaettigt'::text AND a.neigung = 2)) * b.ant_los3 + (( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 7 AND a.vk_sit = 'Land/HVS/60/stop+go'::text AND a.neigung = 2)) * b.ant_los4) * 365::double precision / 1000::double precision
                    WHEN b.neigung = 4 AND b.vsit::text = 'Land/HVS/60'::text THEN b.dtv2015_snf::double precision * ((( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 7 AND a.vk_sit = 'Land/HVS/60/fluessig'::text AND a.neigung = 4)) * b.ant_los1 + (( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 7 AND a.vk_sit = 'Land/HVS/60/dicht'::text AND a.neigung = 4)) * b.ant_los2 + (( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 7 AND a.vk_sit = 'Land/HVS/60/gesaettigt'::text AND a.neigung = 4)) * b.ant_los3 + (( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 7 AND a.vk_sit = 'Land/HVS/60/stop+go'::text AND a.neigung = 4)) * b.ant_los4) * 365::double precision / 1000::double precision
                    WHEN b.neigung = 6 AND b.vsit::text = 'Land/HVS/60'::text THEN b.dtv2015_snf::double precision * ((( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 7 AND a.vk_sit = 'Land/HVS/60/fluessig'::text AND a.neigung = 6)) * b.ant_los1 + (( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 7 AND a.vk_sit = 'Land/HVS/60/dicht'::text AND a.neigung = 6)) * b.ant_los2 + (( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 7 AND a.vk_sit = 'Land/HVS/60/gesaettigt'::text AND a.neigung = 6)) * b.ant_los3 + (( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 7 AND a.vk_sit = 'Land/HVS/60/stop+go'::text AND a.neigung = 6)) * b.ant_los4) * 365::double precision / 1000::double precision
                    WHEN b.neigung = 0 AND b.vsit::text = 'Land/HVS/70'::text THEN b.dtv2015_snf::double precision * ((( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                    ...
                    WHEN b.neigung = 0 AND b.vsit::text = 'Land/Sammel/50'::text THEN b.dtv2015_snf::double precision * ((( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 7 AND a.vk_sit = 'Land/Sammel/50/fluessig'::text AND a.neigung = 0)) * b.ant_los1 + (( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 7 AND a.vk_sit = 'Land/Sammel/50/dicht'::text AND a.neigung = 0)) * b.ant_los2 + (( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 7 AND a.vk_sit = 'Land/Sammel/50/gesaettigt'::text AND a.neigung = 0)) * b.ant_los3 + (( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 7 AND a.vk_sit = 'Land/Sammel/50/stop+go'::text AND a.neigung = 0)) * b.ant_los4) * 365::double precision / 1000::double precision
                    WHEN b.neigung = 2 AND b.vsit::text = 'Land/Sammel/50'::text THEN b.dtv2015_snf::double precision * ((( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 7 AND a.vk_sit = 'Land/Sammel/50/fluessig'::text AND a.neigung = 2)) * b.ant_los1 + (( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 7 AND a.vk_sit = 'Land/Sammel/50/dicht'::text AND a.neigung = 2)) * b.ant_los2 + (( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 7 AND a.vk_sit = 'Land/Sammel/50/gesaettigt'::text AND a.neigung = 2)) * b.ant_los3 + (( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 7 AND a.vk_sit = 'Land/Sammel/50/stop+go'::text AND a.neigung = 2)) * b.ant_los4) * 365::double precision / 1000::double precision
                    WHEN b.neigung = 4 AND b.vsit::text = 'Land/Sammel/50'::text THEN b.dtv2015_snf::double precision * ((( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 7 AND a.vk_sit = 'Land/Sammel/50/fluessig'::text AND a.neigung = 4)) * b.ant_los1 + (( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 7 AND a.vk_sit = 'Land/Sammel/50/dicht'::text AND a.neigung = 4)) * b.ant_los2 + (( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 7 AND a.vk_sit = 'Land/Sammel/50/gesaettigt'::text AND a.neigung = 4)) * b.ant_los3 + (( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 7 AND a.vk_sit = 'Land/Sammel/50/stop+go'::text AND a.neigung = 4)) * b.ant_los4) * 365::double precision / 1000::double precision
                    WHEN b.neigung = 6 AND b.vsit::text = 'Land/Sammel/50'::text THEN b.dtv2015_snf::double precision * ((( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 7 AND a.vk_sit = 'Land/Sammel/50/fluessig'::text AND a.neigung = 6)) * b.ant_los1 + (( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 7 AND a.vk_sit = 'Land/Sammel/50/dicht'::text AND a.neigung = 6)) * b.ant_los2 + (( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 7 AND a.vk_sit = 'Land/Sammel/50/gesaettigt'::text AND a.neigung = 6)) * b.ant_los3 + (( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
                      WHERE a.fhz_art = 'SNF'::text AND a.schast = 7 AND a.vk_sit = 'Land/Sammel/50/stop+go'::text AND a.neigung = 6)) * b.ant_los4) * 365::double precision / 1000::double precision
                    WHEN b.neigung = 0 AND b.vsit::text = 'Land/Sammel/60'::text THEN b.dtv2015_snf::double precision * ((( SELECT a.efak
                       FROM ekat2015.efak_streckenverkehr a
